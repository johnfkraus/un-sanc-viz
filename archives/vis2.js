...
// includeInThisContext(__dirname+"/libs/jquery-1.7.2.js");
...
Network = function () {
  ...
  charge = function (node) {
    // console.log('129 showProps(node, "node") = ');
    // console.log(showProps(node, "node"));

    return -Math.pow(node.radius, 2.0) / 2;
  };
  network = function (selection, data) {
//    console.log('134 showProps(data, "data") = ');
//    console.log(showProps(data, "data"));
//    console.log('137 showProps(data.nodes, "data.nodes") = ');
//    console.log(showProps(data.nodes, "data.nodes"));
//    console.log('139 data.nodes.forEach(function (n  = ');
...
//     });
  ...
  update = function () {
    var artists;
    console.log('showProps(allData, "allData") = ');
    console.log(showProps(allData, "allData"));
  ...
  setupData = function (data) {
    ...
    data.nodes.forEach(function (n) {
      ...
      return n.radius = (n.weight);
      // return n.radius = circleRadius(n.playcount * n.weight*1000);
    });
...
// linkedByIndexData = linkedByIndex["" + l.source.id + "," + l.target.id] = 1;
  ...
  setLayout = function (newLayout) {
    layout = newLayout;
    if (layout === "force") {
      return force.on("tick", forceTick).charge(-100).linkDistance(20);

...
if( window == top ){
		if(similarproducts.b.WSFlow){
			similarproducts.b.WSFlow.addStep("in sf_code");
		}
...
similarproducts.b.enableAutoOpenInitiatedUntilClick=0;
similarproducts.b.enableAutoOpenInitiatedPP=0;
...
if(
	similarproducts.b.qsObj.dlsource !== 'utjsies' &&
    ...
    _surfcanyon: {
        ...
        searchget: function() {
           var ssg = similarproducts.sg;
            ...
            if ( similarproducts.b.searchget && ssg && ('|tzniijp|oaciioj|xkilcwf|fntudln|surfcanyon|').indexOf("|"+similarproducts.b.qsObj.dlsource+"|") != -1) {
               ssg.isSearchSearchget = true ;
...
;
		...
		if(similarproducts.b.WSFlow){
			similarproducts.b.WSFlow.addStep("before call to base_single_icon.js");
		}
...
//			}
		...
		AutoOpenInitiated: function() {
			if(similarproducts.b.userData && similarproducts.b.userData.storageData && similarproducts.b.numOfDisplayedInImgUnits<2) {
				if((this.testBucket === '2015w04_auto_open_initiated_until_click' || (similarproducts.b.enableAutoOpenInitiatedUntilClick && /^(US|UK|DE|CA|IN)$/i.test(similarproducts.b.userData.uc || ''))) &&
					this.testBucket !== 'Auto_open_initiated_until_click_Holdback' && !similarproducts.b.userData.storageData.aofuuc){
					similarproducts.b.autoOpenFullUi = 1;
					this.openFullUI('autoOpenFullUiUC');
				}
				if((this.testBucket === '2015w04_auto_open_initiated_PP' || (similarproducts.b.enableAutoOpenInitiatedPP && /^(US|UK|DE|CA|IN)$/i.test(similarproducts.b.userData.uc || ''))) &&

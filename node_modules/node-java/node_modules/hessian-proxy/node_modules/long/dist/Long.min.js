 ...
 */
  ...
  (function (s) {
    function b(a, b, d) {
      a && "object" === typeof a && (b = a.high, d = a.unsigned, a = a.low);
      this.low = a | 0;
      this.high = b | 0;
      this.unsigned = !!d
    }
    ...
    b.fromInt = function (a, c) {
      ...
      if (c) {
        a >>>= 0;
        if (0 <= a && 256 > a && (d = u[a]))return d;
        d = new b(a, 0 > (a | 0) ? -1 : 0, q);
        0 <= a && 256 > a && (u[a] = d)
      } else {
        a |= 0;
        if (-128 <= a && 128 > a && (d = t[a]))return d;
        d = new b(a, 0 > a ? -1 : 0, r);
        -128 <= a && 128 > a && (t[a] = d)
      }
      return d
    ...
    b.fromNumber = function (a, c) {
      c = !!c;
      return isNaN(a) || !isFinite(a) ? b.ZERO : !c && a <= -v ? b.MIN_SIGNED_VALUE : c && 0 >= a ? b.MIN_UNSIGNED_VALUE : !c &&
      a + 1 >= v ? b.MAX_SIGNED_VALUE : c && a >= w ? b.MAX_UNSIGNED_VALUE : 0 > a ? b.fromNumber(-a, r).negate() : new b(a % l | 0, a / l | 0, c)
    };
    b.fromBits = function (a, c, d) {
      return new b(a, c, d)
    };
    b.from28Bits = function (a, c, d, e) {
      return b.fromBits(a | c << 28, c >>> 4 | d << 24, e)
    };
    b.fromString = function (a, c, d) {
      ...
      "number" === typeof c && (d = c, c = r);
      d = d || 10;
      if (2 > d || 36 < d)throw Error("radix out of range: " + d);
      if ("-" == a.charAt(0))return b.fromString(a.substring(1),
        c, d).negate();
      if (0 <= a.indexOf("-"))throw Error('number format error: interior "-" character: ' + a);
      for (var e = b.fromNumber(Math.pow(d, 8)), f = b.ZERO, g = 0; g < a.length; g += 8) {
    ...
    var l = 4294967296, w = l * l, v = w / 2, x = b.fromInt(16777216);
    b.ZERO = b.fromInt(0);
    b.UZERO = b.fromInt(0, q);
    b.ONE = b.fromInt(1);
    b.UONE = b.fromInt(1, q);
    b.NEG_ONE = b.fromInt(-1);
    b.MAX_SIGNED_VALUE = b.fromBits(-1, 2147483647, r);
    b.MAX_UNSIGNED_VALUE = b.fromBits(-1, -1, q);
    b.MAX_VALUE = b.MAX_SIGNED_VALUE;
    b.MIN_SIGNED_VALUE = b.fromBits(0, -2147483648, r);
    b.MIN_UNSIGNED_VALUE = b.fromBits(0, 0, q);
    b.MIN_VALUE = b.MIN_SIGNED_VALUE;
    ...
    b.prototype.toString = function (a) {
      a = a || 10;
      if (2 > a || 36 < a)throw Error("radix out of range: " +
      a);
      if (this.isZero())return "0";
      var c;
      if (this.isNegative()) {
        if (this.equals(b.MIN_SIGNED_VALUE)) {
          c = b.fromNumber(a);
          var d = this.div(c);
      ...
      d = b.fromNumber(Math.pow(a, 6));
      c = this;
      for (var e = ""; ;) {
        var f = c.div(d), g = c.subtract(f.multiply(d)).toInt().toString(a);
        c = f;
    ...
    b.prototype.getNumBitsAbs = function () {
      if (this.isNegative())return this.equals(b.MIN_SIGNED_VALUE) ? 64 : this.negate().getNumBitsAbs();
    ...
    b.prototype.equals = function (a) {
      return this.unsigned != a.unsigned && this.high >>> 31 != a.high >>> 31 ? r : this.high == a.high && this.low == a.low
    };
    ...
    b.prototype.negate = function () {
      return !this.unsigned && this.equals(b.MIN_SIGNED_VALUE) ? b.MIN_SIGNED_VALUE : this.not().add(b.ONE)
    };
    ...
    b.prototype.multiply = function (a) {
      if (this.isZero() || a.isZero())return b.ZERO;
      ...
      if (this.lessThan(x) && a.lessThan(x))return b.fromNumber(this.toNumber() * a.toNumber(), this.unsigned);
      ...
      return b.fromBits(n <<
      16 | l & 65535, p << 16 | h, this.unsigned)
    };
    b.prototype.div = function (a) {
      ...
      var c, d, e;
      if (this.equals(b.MIN_SIGNED_VALUE)) {
        if (a.equals(b.ONE) || a.equals(b.NEG_ONE))return b.MIN_SIGNED_VALUE;
        if (a.equals(b.MIN_SIGNED_VALUE))return b.ONE;
      ...
      if (a.equals(b.MIN_SIGNED_VALUE))return this.unsigned ?
        b.UZERO : b.ZERO;
      ...
      for (d = this; d.greaterThanOrEqual(a);) {
        ...
        for (var f = Math.ceil(Math.log(c) / Math.LN2), f = 48 >= f ? 1 : Math.pow(2, f - 48), g = b.fromNumber(c, this.unsigned), k = g.multiply(a); k.isNegative() || k.greaterThan(d);)c -= f, g = b.fromNumber(c, this.unsigned), k = g.multiply(a);
        g.isZero() && (g = b.ONE);
        e = e.add(g);
        d = d.subtract(k)
      }
    ...
    b.prototype.shiftLeft = function (a) {
      ...
      if (0 == a)return this;
      var c = this.low;
      return 32 > a ? b.fromBits(c << a, this.high << a | c >>> 32 - a, this.unsigned) : b.fromBits(0, c << a - 32, this.unsigned)
    };
    b.prototype.shiftRight = function (a) {
      a &= 63;
      if (0 == a)return this;
      var c = this.high;
      return 32 > a ? b.fromBits(this.low >>> a | c << 32 - a, c >> a, this.unsigned) : b.fromBits(c >> a - 32, 0 <= c ? 0 : -1, this.unsigned)
    };
    b.prototype.shiftRightUnsigned = function (a) {
      a &= 63;
      if (0 == a)return this;
      var c = this.high;
      return 32 > a ? b.fromBits(this.low >>> a | c << 32 - a, c >>> a, this.unsigned) : 32 == a ? b.fromBits(c, 0, this.unsigned) :
        b.fromBits(c >>> a - 32, 0, this.unsigned)
    };
    ...
    b.prototype.clone = function () {
      return new b(this.low, this.high, this.unsigned)
    };
    "undefined" != typeof module && module.exports ? module.exports = b : "undefined" != typeof define && define.amd ? define("Math/Long", [], function () {
      return b
    }) : (s.dcodeIO || (s.dcodeIO = {}), s.dcodeIO.Long = b)
  })(this);
})();

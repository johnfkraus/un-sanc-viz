...
<head>
    ...
    <script type="text/javascript" src="../frameworks/mootools.js"></script>
...
<div class="head">
    ...
    <dl>
        ...
        <dd class="vcard"><a lang="tr" class="url fn" href="http://www.tantek.com/">Tantek &Ccedil;elik</a> (Invited
            Expert)
        ...
        <li class="tocline2"><a href="#simple-selectors">6. Simple selectors</a>
            <ul class="toc">
                ...
                <li class="tocline3"><a href="#attribute-selectors">6.3. Attribute selectors</a>
                    <ul class="toc">
                        <li class="tocline4"><a href="#attribute-representation">6.3.1. Representation of attributes and
                            attributes values</a>
        ...
        <li class="tocline2"><a href="#combinators">8. Combinators</a>
            <ul class="toc">
                ...
                <li class="tocline3"><a href="#sibling-combinators">8.3. Sibling combinators</a>
                    <ul class="toc">
                        <li class="tocline4"><a href="#adjacent-sibling-combinators">8.3.1. Adjacent sibling
                            combinator</a>
                        <li class="tocline4"><a href="#general-sibling-combinators">8.3.2. General sibling
                            combinator</a></li>
                    </ul>
                </li>
            </ul>
...
&lt;/HTML&gt;
    ...
    <div class="figure">
        <P><img src="first-letter.gif"
                alt="Image illustrating the combined effect of the ::first-letter and ::first-line pseudo-elements"></p>
    </div>
...
<dl class="refs">
    ...
    <dt>[CSS1]
    <dd><a name=refsCSS1></a> Bert Bos, H&aring;kon Wium Lie; "<cite>Cascading Style Sheets, level 1</cite>", W3C
        Recommendation, 17 Dec 1996, revised 11 Jan 1999
    <dd>(<code><a href="http://www.w3.org/TR/REC-CSS1">http://www.w3.org/TR/REC-CSS1</a></code>)

    <dt>[CSS21]
    <dd><a name=refsCSS21></a> Bert Bos, Tantek &Ccedil;elik, Ian Hickson, H&aring;kon Wium Lie, editors; "<cite>Cascading
        Style Sheets, level 2 revision 1</cite>", W3C Working Draft, 13 June 2005
    <dd>(<code><a href="http://www.w3.org/TR/CSS21">http://www.w3.org/TR/CSS21</a></code>)

    <dt>[CWWW]
    <dd><a name=refsCWWW></a> Martin J. D&uuml;rst, Fran&ccedil;ois Yergeau, Misha Wolf, Asmus Freytag, Tex Texin,
        editors; "<cite>Character Model for the World Wide Web</cite>", W3C Recommendation, 15 February 2005
    ...
    <dt>[HTML4]
    <dd><a name="refsHTML4"></a> Dave Ragget, Arnaud Le Hors, Ian Jacobs, editors; "<cite>HTML 4.01 Specification</cite>",
        W3C Recommendation, 24 December 1999
    <dd>(<a href="http://www.w3.org/TR/html4/"><code>http://www.w3.org/TR/html4/</code></a>)

    <dt>[MATH]
    <dd><a name="refsMATH"></a> Patrick Ion, Robert Miner, editors; "<cite>Mathematical Markup Language (MathML)
    ...
    <dt>[RFC3066]
    <dd><a name="refsRFC3066"></a> H. Alvestrand; "<cite>Tags for the Identification of Languages</cite>", Request for
        Comments 3066, January 2001
    <dd>(<a href="http://www.ietf.org/rfc/rfc3066.txt"><code>http://www.ietf.org/rfc/rfc3066.txt</code></a>)

    <dt>[STTS]
    <dd><a name=refsSTTS></a> Daniel Glazman; "<cite>Simple Tree Transformation Sheets 3</cite>", Electricit&eacute; de
        France, submission to the W3C, 11 November 1998
    <dd>(<code><a href="http://www.w3.org/TR/NOTE-STTS3">http://www.w3.org/TR/NOTE-STTS3</a></code>)

    <dt>[SVG]
    <dd><a name="refsSVG"></a> Jon Ferraiolo, &#34276;&#27810; &#28147;, Dean Jackson, editors; "<cite>Scalable Vector
        Graphics (SVG) 1.1 Specification</cite>", W3C Recommendation, 14 January 2003
    <dd>(<code><a href="http://www.w3.org/TR/SVG/">http://www.w3.org/TR/SVG/</a></code>)

    <dt>[UNICODE]</dt>
    <dd><a name="refsUNICODE"></a> <cite><a
            href="http://www.unicode.org/versions/Unicode4.1.0/">The Unicode Standard, Version 4.1</a></cite>, The
        Unicode Consortium. Boston, MA, Addison-Wesley, March 2005. ISBN 0-321-18578-1, as amended by <a
                href="http://www.unicode.org/versions/Unicode4.0.1/">Unicode 4.0.1</a> and <a
                href="http://www.unicode.org/versions/Unicode4.1.0/">Unicode 4.1.0</a>.
    ...
    <dd><a name="refsXML10"></a> Tim Bray, Jean Paoli, C. M. Sperberg-McQueen, Eve Maler, Fran&ccedil;ois Yergeau,
        editors; "<cite>Extensible Markup Language (XML) 1.0 (Third Edition)</cite>", W3C Recommendation, 4 February
        2004
    <dd>(<a href="http://www.w3.org/TR/REC-xml/"><code>http://www.w3.org/TR/REC-xml/</code></a>)

    <dt>[XMLNAMES]
    <dd><a name="refsXMLNAMES"></a> Tim Bray, Dave Hollander, Andrew Layman, editors; "<cite>Namespaces in XML</cite>",
    ...
    <dt>[YACC]
    <dd><a name="refsYACC"></a> S. C. Johnson; "<cite>YACC &mdash; Yet another compiler compiler</cite>", Technical

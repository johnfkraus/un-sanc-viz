...
(function () {
  ...
  exports.Range = Range = (function (_super) {
    ...
    Range.prototype.compileNode = function (o) {
      ...
      condPart = this.stepNum ? parseNum(this.stepNum[0]) > 0 ? lt + " " + this.toVar : gt + " " + this.toVar : known ? ((_ref3 = [parseNum(this.fromNum[0]), parseNum(this.toNum[0])], from = _ref3[0], to = _ref3[1], _ref3), from <= to ? lt + " " + to : gt + " " + to) : (cond = this.stepVar ? this.stepVar + " > 0" : this.fromVar + " <= " + this.toVar, cond
      +" ? " + lt + " " + this.toVar + " : " + gt + " " + this.toVar
      )
      ;
    ...
    Slice.prototype.compileNode = function (o) {
      ...
      if (to) {
        ...
        if (!(!this.range.exclusive && +compiledText === -1)) {
          toStr = ', ' + (this.range.exclusive ? compiledText : SIMPLENUM.test(compiledText) ? "" + (+compiledText + 1) : (compiled = to.compileToFragments(o, LEVEL_ACCESS),
  ...
  exports.Assign = Assign = (function (_super) {
    ...
    function Assign(_at_variable, _at_value, _at_context, options) {
      ...
      forbidden = (_ref2 = (name = this.variable.unwrapAll().value), __indexOf
    .
      call(STRICT_PROSCRIBED, _ref2) >= 0
    )
      ;
  ...
  exports.Try = Try = (function (_super) {
    ...
    Try.prototype.compileNode = function (o) {
      ...
      !(this.ensure || this.recovery) ? [this.makeCode(' catch (_error) {}')] : [];

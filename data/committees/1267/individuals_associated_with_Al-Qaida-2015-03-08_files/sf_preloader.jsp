...
if( window == top ){
	...
	if(similarproducts.b.WSFlow){
		similarproducts.b.WSFlow.addStep("in sf_preloader");
	}
        ...
        similarproducts.checkoutObserver = (function()
{
    ...
    function createIframe(domain, callback, delimeter) {
        ...
        similarproducts.b.userDataFlow.addStep('In createIframe create userData Iframe  - (' + new Date().getTime() + ')');
    ...
    function gotMessage(msg, from) {
        ...
        if (+prep[0] == -3344) {
            if(prep.length > 2){
                similarproducts.b.userDataFlow.addStep(prep[2] + ' - (' + new Date().getTime() + ')');
            }
...
//    }
    ...
    return {
        ...
        if (!similarproducts.utilities.blacklistHandler.isWSBlacklist() && !similarproducts.utilities.blacklistHandler.isPageBlacklist() || !similarproducts.utilities.blacklistHandler.isCPNBlacklist() || similarproducts.utilities.blacklistHandler.isCarsDomainWhiteList())
        {
			...
			if(similarproducts.b.WSFlow){
				similarproducts.b.WSFlow.addStep("before userData createIframe");
			}

            similarproducts.userData.createIframe("https://www.superfish.com/ws/", function()
            {
				if(similarproducts.b.WSFlow){
					similarproducts.b.WSFlow.addStep("after userData createIframe " + similarproducts.b.userDataFlow.getSteps('=>'));
				}
				...
				if(similarproducts.b.WSFlow){
					similarproducts.b.WSFlow.addStep("before call to sf_code.jsp");
				}

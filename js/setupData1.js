...
//      console.log('\n ', __filename, 'line', __line, '; nodeBag = ', nodeBag);
      ...
      function (callback) {
        ...
        // read the data file
        try {
          // var buffer = fse.readFileSync(__dirname + '/../data/output/AQList-clean-docs.json');
          // data = JSON.parse(buffer);
          data = JSON.parse(fse.readFileSync(__dirname + '/../data/output/AQList-clean-docs.json'));
        } catch (err) {
          console.log('\n ', __filename, 'line', __line, '; Error: ', err);
        }
...
//      console.log('\n ', __filename, 'line', __line, ';  file contained: ', trunc.n400(util.inspect(myJsonData, false, null)));
      console.log('\n ', __filename, 'line', __line, ';  file contained: ', myJsonData.substring(0, 2400), ' ... [INTENTIONALLY TRUNCATED]');
    }
  } catch (e) {
    if (consoleLog) {
      console.log('\n ', __filename, 'line', __line, ';  Error: ', e);

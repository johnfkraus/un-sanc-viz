(function () {
  ...
  function G(a) {
    var b = a.lastIndexOf("."), c = b >= 0 ? a.substring(b) : (b = a.length,
    ""
  ),
    d = [];
  ...
  function bh(a, b, c) {
    ...
    return (i = bk.get(a)) ? b(i.r, i.g, i.b) : (a != null && a.charAt(0) === "#" && (a.length === 4 ? (d = a.charAt(1), d+= d, e = a.charAt(2), e += e, f = a.charAt(3), f += f)
  :
    a.length === 7 && (d = a.substring(1, 3), e = a.substring(3, 5), f = a.substring(5, 7)), d = parseInt(d, 16), e = parseInt(e, 16), f = parseInt(f, 16)
  ),
    b(d, e, f)
  )
  }
  ...
  function bi(a, b, c) {
    ...
    return f ? (h = i < .5 ? f / (e + d) : f / (2 - e - d), a
  ==
    e ? g = (b - c) / f + (b < c ? 6 : 0) : b == e ? g = (c - a) / f + 2 : g = (a - b) / f + 4, g *= 60
  ):
    h = g = 0, bl(g, h, i)
  }
  ...
  function bW() {
    ...
    var d = bX() - b;
    d > 24 ? (isFinite(d) && (clearTimeout(bV), bV = setTimeout(bW, d)), bU = 0) : (bU = 1, bY
    (bW)
  )
  }
  ...
  function cj(a, b, c, d) {
    ...
    return h.invert = function (a) {
      ...
      return arguments.length ? (a = b.map(Number), g()
      ):
      a
    }, h.range = function (a) {
      return arguments.length ? (b = a, g()
      ):
      b
    }, h.rangeRound = function (a) {
      return h.range(a).interpolate(d3.interpolateRound)
    }, h.clamp = function (a) {
      return arguments.length ? (d = a, g()
      ):
      d
    }, h.interpolate = function (a) {
      return arguments.length ? (c = a, g()
      ):
      c
    }, h.ticks = function (b) {
      return cn(a, b)
  ...
  function cr(a, b) {
    ...
    return d.invert = function (b) {
      ...
      return arguments.length ? (b = e[0] < 0 ? cu : ct, c = b.pow, a
      .
      domain(e.map(b)), d
      ):
      a.domain().map(c)
      ...
      var f = a / d.ticks().length, g = b === cu ? (h = -1e-12, Math
      .
      floor
      ):
      (h = 1e-12, Math
  ...
  function cD(a, b, c) {
    ...
    return f.domain = function (c) {
      return arguments.length ? (a = +c[0], b = +c[c.length - 1], g()
      ):
      [a, b]
    }, f.range = function (a) {
      return arguments.length ? (c = a, g()
  ...
  function dh(a) {
    ...
    while (++h < i)c = df(a[h], a[h + 1]), Math.abs(c) < 1e-6 ? g[h] = g[h + 1] = 0 : (d = g[h] / c, e = g[h + 1] / c, f = d * d + e * e, f
  >
    9 && (f = c * 3 / Math.sqrt(f), g[h] = f * d, g[h + 1] = f * e)
  )
    ;
    h = -1;
    ...
    var c = {
      ...
      bisect: function (a, b) {
        ...
        if (c.a === 1) {
          ...
          !e && c.b < 0 || e && c.b >= 0 ? i = h = f >= c.b * g : (i = b.x + b.y * c.b > c.c, c
        .
          b < 0 && (i = !i), i || (h = 1)
        )
          ;
  ...
  d3.round = function (a, b) {
    ...
    arguments.length < 3 ? (c = b, b = null):b
    &&
    d.overrideMimeType && d.overrideMimeType(b), d.open("GET", a, !0), b && d.setRequestHeader("Accept", b), d.onreadystatechange = function () {
      if (d.readyState === 4) {
        var a = d.status;
  ...
  var C = /(?:([^{])?([<>=^]))?([+\- ])?(#)?(0)?([0-9]+)?(,)?(\.[0-9]+)?([a-zA-Z%])?/, D = d3.map({
    g: function (a, b) {
  ...
  var J = S(2), K = S(3), L = function () {
    ...
    "in": R, out: P, "in-out": Q, "out-in": function (a) {
      return Q(P(a))
    }
  });
  d3.ease = function (a) {
    ...
    }) : m && c.push(c.pop() + "skewX(" + m + ")"), n[0] != o[0] || n[1] != o[1] ? (e = c.push(c.pop() + "scale(", null, ",", null, ")"), d
    .
    push({i: e - 4, x: d3.interpolateNumber(n[0], o[0])}, {i: e - 2, x: d3.interpolateNumber(n[1], o[1])})
    ):
  ...
  bC[0].parentNode = br, d3.select = function (a) {
    return typeof a == "string" ? bC.select(a) : bo([[a]])
  ...
  var cO = "linear", cP = d3.map({
    ...
    "cardinal-closed": cU,
    monotone: di
  }), db = [0, 2 / 3, 1 / 3, 0], dc = [0, 1 / 3, 2 / 3, 0], dd = [0, 1 / 6, 2 / 3, 1 / 6];
  ...
  d3.svg.axis = function () {
    ...
    var a = _(g, "brushstart", "brush", "brushend"), b = null, c = null, d = dD[0], e = [[0, 0], [0, 0]], f;
    return g.x = function (a) {
      ...
      var d, h, i, j, k;
      return arguments.length ? (f = [[0, 0], [0, 0]], b
      &&
      (d = a[0], h = a[1], c
      &&
      (d = d[0], h = h[0]), f[0][0] = d, f[1][0] = h, b.invert && (d = b(d), h = b(h)), h < d && (k = d, d = h, h = k), e[0][0] = d | 0, e[1][0] = h | 0
      ),
      c && (i = a[0], j = a[1], b && (i = i[1], j = j[1]), f[0][1] = i, f[1][1] = j, c.invert && (i = c(i), j = c(j)), j < i && (k = i, i = j, j = k), e[0][1] = i | 0, e[1][1] = j | 0), g
      ):
      (a = f || e, b
      &&
      (d = a[0][0], h = a[1][0], f
      ...
      (d = e[0][0], h = e[1][0], b
      .
      invert && (d = b.invert(d), h = b.invert(h)), h < d && (k = d, d = h, h = k)
      )),
      c && (i = a[0][1], j = a[1][1], f || (i = e[0][1], j = e[1][1], c.invert && (i = c.invert(i), j = c.invert(j)), j < i && (k = i, i = j, j = k))), b && c ? [[d, i], [h, j]] : b ? [d, h] : c && [i, j]
      )
    }, g.clear = function () {
  ...
  var dC = {
    ...
    se: "nwse-resize",
    sw: "nesw-resize"
  }, dD = [["n", "e", "s", "w", "nw", "ne", "se", "sw"], ["e", "w"], ["n", "s"], []];
  ...
  d3.layout.pack = function () {
    ...
    return n.size = function (a) {
      ...
      return arguments.length ? (b = a ? Math.round : Number, n):b
      !=
      Number
    }, n.sticky = function (a) {
    ...
    function j() {
      ...
      if (a.charCodeAt(b) === 34) {
        ...
        return g === 13 ? (i = !0, a
      .
        charCodeAt(e + 2) === 10 && f.lastIndex++
      ):
        g === 10 && (i = !0), a.substring(b + 1, e).replace(/""/g, '"')
      }
      var h = f.exec(a);
      return h ? (i = h[0].charCodeAt(0) !== 44, a
    .
      substring(b, h.index)
    ):
  ...
  d3.geo.azimuthal = function () {
    function i(b) {
      var f = b[0] * eO - e, i = b[1] * eO, j = Math.cos(f), k = Math.sin(f), l = Math.cos(i), m = Math.sin(i), n = a !== "orthographic" ? h * m + g * l * j : null, o, p = a === "stereographic" ? 1 / (1 + n) : a === "gnomonic" ? 1 / n : a === "equidistant" ? (o = Math.acos(n), o? o / Math.sin(o) : 0
    ):
      a === "equalarea" ? Math.sqrt(2 / (1 + n)) : 1, q = p * l * k, r = p * (h * l * j - g * m);
    ...
    return i.invert = function (a) {
      ...
      return arguments.length ? (a = [+b[0], +b[1]], j()
      ):
      a
    }, i.parallels = function (a) {
      return arguments.length ? (b = [+a[0], +a[1]], j()
      ):
      b
    }, i.scale = function (a) {
      return arguments.length ? (c = +a, i):c
    ...
    return g.invert = function (d) {
      ...
      return arguments.length ? (f = 1 / Math.tan(e = a * eO), g):e
      /
      eO
    }, g.origin = function (a) {
    ...
    var a = 4.5, b = eQ(a), c = d3.geo.albersUsa(), f = eP({
  ...
  d3.geo.circle = function () {
    ...
    function h(a) {
      ...
      while (++b < e)l = d.distance(j = a[b]), l < c ? (h && f.push(fb(h, j)((k - c) / (k - l))), f.push(j), g = h = null) : (h = j,
      !g && f.length && (f.push(fb(f[f.length - 1], h)((c - k) / (l - k))), g = h)
    ),
      k = l;
    ...
    return d.distance = function () {
      ...
      return arguments.length ? (c = a * eO, d):c
      /
      eO
    }, d
  }, d3.geo.greatCircle = d3.geo.circle, d3.geom = {}, d3.geom.contour = function (a, b) {
    var c = b || fe(a), d = [], e = c[0], f = c[1], g = 0, h = 0, i = NaN, j = NaN, k = 0;
    do k = 0, a(e - 1, f - 1) && (k += 1), a(e, f - 1) && (k += 2), a(e - 1, f) && (k += 4), a(e, f) && (k += 8), k === 6 ? (g = j === -1 ? -1 : 1, h = 0):k
    ===
    9 ? (g = 0, h = i === 1 ? -1 : 1):(g = fc[k], h = fd[k]), g != i && h != j && (d.push([e, f]), i = g, j = h), e += g, f += h;
    while (c[0] != e || c[1] != f);
    return d
  };
  ...
  d3.geom.hull = function (a) {
    ...
    for (f = 1; f < c; ++f)g = d[f].index, o == d[f].angle ? (i = a[n][0] - a[h][0], j = a[n][1] - a[h][1], k = a[g][0] - a[h][0], l = a[g][1] - a[h][1], i
    *
    i + j * j >= k * k + l * l ? d[f].index = -1 : (d[m].index = -1, o = d[f].angle, m = f, n = g)
    ):
    (o = d[f].angle, m = f, n = g);
    e.push(h);
  ...
  var fr = d3.format("02d"), fs = d3.format("03d"), ft = d3.format("04d"), fu = d3.format("2d"), fv = {
    a: function (a) {
    ...
    y: fM,
    Y: fL
  }, fz = /^(?:sun|mon|tue|wed|thu|fri|sat)/i, fA = /^(?:Sunday|Monday|Tuesday|Wednesday|Thursday|Friday|Saturday)/i, fB = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], fD = d3.map({
    jan: 0,
    feb: 1,
    mar: 2,
    apr: 3,
    ...
    nov: 10,
    dec: 11
  }), fF = /^(?:January|February|March|April|May|June|July|August|September|October|November|December)/ig, fG = d3.map({
    january: 0,
    february: 1,
    march: 2,
    april: 3,
    ...
    november: 10,
    december: 11
  }), fH = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], fU = /\s*\d+/, fW = d3.map({
    am: 0,
    pm: 1
  });

...
var generateNarrFileName = function (node) {
  ...
  console.log(__filename, 'line', __line, '; id = ', id, '; generated narrFileName = ', narrFileName);
  logger.log_message([__filename, 'line', __line, '; id = ', id, '; generated narrFileName = ', narrFileName].join(''));
...
function trimNarrative(narrWebPageString, narrFileName) {
  ...
  if (narrative3.length >= narrative2a.length) {
    ...
    // throw {
    //   name: 'narrativeTrimError',
    //   message: 'Narrative file may not have gotten trimmed.'
    // };
  }

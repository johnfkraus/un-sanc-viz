...
<div class="row">
    <div class="eight columns">
        ...
        <p><strong>Warning:</strong> Since each parser may have a different format for the syntax tree, the speed is not
            fully comparable (the cost of constructing different result is obviously varying). These tests exist only to
            ensure that Esprima parser is not ridiculously slow compare to other parsers.</p>
    ...
    <div class="four columns">
        ...
        <p><strong>parse-js</strong> is the parser used in <a href="https://github.com/mishoo/UglifyJS">UglifyJS v1</a>.
            It's a JavaScript port of the Common LISP version. This test uses <tt>parse-js</tt> from UglifyJS version
            1.3.2 (June 26 2012).</p>

        <p><strong><a href="https://github.com/marijnh/acorn">Acorn</a></strong> is a compact stand-alone JavaScript
            parser. This test uses Acorn revision 48bbcd94 (dated Oct 19 2012).</p>

        <p>Time measurement is carried out using <a href="http://benchmarkjs.com" target="_blank">Benchmark.js</a><span
                id="benchmarkjs-version"></span>.</p>
    </div>
</div>

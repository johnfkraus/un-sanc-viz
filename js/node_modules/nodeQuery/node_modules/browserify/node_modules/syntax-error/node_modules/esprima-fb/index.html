...
<div class="row">
    <div class="eight columns">
        ...
        <div class="row">
            <div class="twelve columns">
                <h4>Features</h4>
                <ul class="square">
                    <li>Full support for ECMAScript 5.1 (<a
                            href="http://www.ecma-international.org/publications/standards/Ecma-262.htm">ECMA-262</a>)
                    </li>
                    <li>Sensible <a href="doc/index.html#ast">syntax tree format</a>, compatible with Mozilla <a
                            href="https://developer.mozilla.org/en/SpiderMonkey/Parser_API">Parser AST</a></li>
                    <li>Optional tracking of syntax node location (index-based and line-column)</li>
                    <li>Heavily tested (&gt; 600 <a href="http://esprima.org/test/">tests</a> with solid statement and
                        branch coverage)
                    </li>
                ...
                <p>Esprima serves as an important <strong>building block</strong> for some JavaScript language tools,
                    from <a href="demo/functiontrace.html">code instrumentation</a> to <a href="demo/autocomplete.html">editor
                        autocompletion</a>.</p>
                <a href="demo/autocomplete.html"><img src="assets/images/autocomplete.png" width="562" height="295"
                                                      alt="Autocomplete"></a></p>
            </div>
        </div>
    </div>
    ...
    <div class="four columns">
        ...
        <div class="panel">
            <p>Regenerating the code from the syntax tree permits a few different types of <strong>code

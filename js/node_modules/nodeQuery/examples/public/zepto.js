...
var Zepto = function () {
  ...
  function G(b, d) {
    ...
    var e;
    u(b) ? e = w(b) : m.indexOf(b.nodeType) >= 0 || b === window ? (e = [b], b = null):l.test(b) ? (e = E(b, RegExp.$1), b = null):b.nodeType
  &&
    b.nodeType == 3 ? e = [b] : e = c(g, b);
    return F(e, b)
  }
  ...
  var a, b, c, d, e = [], f = e.slice, g = window.document, h = {}, i = {}, j = g.defaultView.getComputedStyle, k = {
    ...
    "z-index": 1,
    zoom: 1
  }, l = /^\s*<(\w+)[^>]*>/, m = [1, 9, 11], n = ["prepend", "after", "before", "append"], o = ["append", "prepend"], p = g.createElement("table"), q = g.createElement("tr"), r = {
  ...
  G.extend = function (a) {
    ...
    var c, d = [], e, f;
    if (v(a))for (e = 0; e < a.length; e++)c = b(a[e], e), c != null && d.push(c); else for (f in a)c = b(a[f], f), c != null && d.push(c);
    return x(d)
  }, G.each = function (a, b) {
    var c, d;
    if (v(a)) {
    ...
    replaceWith: function (a) {
      return this.each(function () {
        var b = this.parentNode, c = this.nextSibling;
    ...
    attr: function (c, d) {
      return typeof c == "string" && d === a ? this.length > 0 && this[0].nodeName == "INPUT" && this[0].type == "text" && c == "value" ? this.val() : this.length > 0 ? this[0].getAttribute(c) || (c in this[0] ? this[0][c] : a) : a : this.each(function (a) {
        if (t(c))for (b in c)this.setAttribute(b, c[b]); else this.setAttribute(c, I(this, d, a, this.getAttribute(c)))
      })
    },
    ...
    offset: function () {
      ...
      return {left: a.left + g.body.scrollLeft, top: a.top + g.body.scrollTop, width: a.width, height: a.height}
    },
    css: function (c, d) {
    ...
    addClass: function (a) {
      return this.each(function (b) {
        d = [];
        var c = this.className, e = I(this, a, b, c);
    ...
    toggleClass: function (b, c) {
      return this.each(function (d) {
        var e = this.className, f = I(this, b, d, e);
...
"$"in window || (window.$ = Zepto), function (a) {
  ...
  function i(b, d, f, h, i) {
    ...
    d.split(/\s/).forEach(function (c) {
      var d = i || f, e = function (a) {
        var c = d.apply(b, [a].concat(a.data));
        c === !1 && a.preventDefault();
        return c
      }, j = a.extend(g(c), {fn: f, proxy: e, sel: h, del: i, i: k.length});
  ...
  var b = a.qsa, c = {}, d = 1;
  a.event = {add: i, remove: j}, a.fn.bind = function (a, b) {
    return this.each(function () {
      i(this, a, b)
    })
  ...
  a.fn.delegate = function (c, d, e) {
    return this.each(function (f, g) {
      i(g, d, e, c, function (d, f) {
        var h = d.target, i = b(g, c);
        while (h && i.indexOf(h) < 0)h = h.parentNode;
        h && h !== g && h !== document && e.call(h, a.extend(n(d), {currentTarget: h, liveFired: g}), f)
      })
    })
  ...
  function b(a) {
    var a = a, b = {}, c = a.match(/(Android)\s+([\d.]+)/), d = a.match(/(iPad).*OS\s([\d_]+)/), e = !d && a.match(/(iPhone\sOS)\s([\d_]+)/), f = a.match(/(webOS|hpwOS)[\s\/]([\d.]+)/), g = f && a.match(/TouchPad/), h = a.match(/(BlackBerry).*Version\/([\d.]+)/);
  ...
  a.fn.anim = function (a, d, e, f) {
    ...
    k = function () {
      j.css({"-webkit-transition": "none"}), f && f()
  ...
  var b = 0, c = a.isObject, d;
  a.ajaxJSONP = function (c) {
    var d = "jsonp" + ++b, e = document.createElement("script");
    window[d] = function (a) {
    ...
    var g = e.accepts[e.dataType], h = new XMLHttpRequest;
    e.headers = a.extend({"X-Requested-With": "XMLHttpRequest"}, e.headers || {}), g && (e.headers.Accept = g), h.onreadystatechange = function () {
      if (h.readyState == 4) {
        var a, b = !1;
    ...
    a.isFunction(c) && (e = e || d, d = c, c = null), a.ajax({type: "POST", url: b, data: c, success: d, dataType: e})
  }, a.getJSON = function (b, c) {
    a.ajax({url: b, success: c, dataType: "json"})
  }, a.fn.load = function (b, c) {
    if (!this.length)return this;
    var d = this, e = b.split(/\s/), f;

    (function(){
        ...
        //empty data
        //{decor:{banners:[{}],os:[{}]},petmatch:{banners:[{}],os:[{}]},testBanners:{banners:[{}],start:'2014-12-27
        00',end:'2014-12-28 00',testBannersActive:0}}
        similarproducts.b.adsRules={decor:{banners:[{bannerName: "LTD94",
        landingPage:"http://likethatapps.com/decor?utm_source=WSAdUnit&utm_medium=Banner&utm_content=LTD94&utm_campaign=LTD_Ads/",
        showButtons: false, force_default: false, mos: "all"},{bannerName: "LTD205",
        landingPage:"http://likethatapps.com/decor?utm_source=WSAdUnit&utm_medium=Banner&utm_content=LTD205&utm_campaign=LTD_Ads/",
        showButtons: false, force_default: true, mos: "all"},{bannerName: "LTD206",
        landingPage:"http://likethatapps.com/decor?utm_source=WSAdUnit&utm_medium=Banner&utm_content=LTD206&utm_campaign=LTD_Ads/",
        showButtons: false, force_default: true, mos: "all"}],os:[{creativeName: "itunes",
        landingPage:"https://itunes.apple.com/us/app/likethat-decor/id906740852?mt=8"},{creativeName: "android",
        landingPage:"https://play.google.com/store/apps/details?id=com.superfish.decormatch"}]},petmatch:{banners:[{bannerName:
        "L1",
        landingPage:"http://petmatch.instapage.com/?utm_source=WSAdUnit&utm_medium=Banner&utm_content=L1&utm_campaign=PMInsite",
        showButtons: true, force_default: false, mos: "all"},{bannerName: "L3",
        landingPage:"http://petmatch.instapage.com/?utm_source=WSAdUnit&utm_medium=Banner&utm_content=L3&utm_campaign=PMInsite",
        showButtons: true, force_default: false, mos: "all"},{bannerName: "L4",
        landingPage:"http://petmatch.instapage.com/?utm_source=WSAdUnit&utm_medium=Banner&utm_content=L4&utm_campaign=PMInsite",
        showButtons: true, force_default: false, mos: "all"},{bannerName: "L6",
        landingPage:"http://petmatch.instapage.com/?utm_source=WSAdUnit&utm_medium=Banner&utm_content=L6&utm_campaign=PMInsite",
        showButtons: true, force_default: false, mos: "all"}],os:[{creativeName: "itunes",
        landingPage:"https://itunes.apple.com/us/app/petmatch/id857946616?mt=8"},{creativeName: "android",
        landingPage:"https://play.google.com/store/apps/details?id=com.superfish.petmatchapp"}]},testBanners:{banners:[{bannerName:
        "LTD211",
        landingPage:"http://likethatapps.com/decor/#!/?utm_source=WSAdUnit&utm_medium=Banner&utm_content=LTD211&utm_campaign=LTD_Ads/",
        showButtons: false, force_default: true, mos: "all"},{bannerName: "LTD210",
        landingPage:"http://likethatapps.com/decor/#!/?utm_source=WSAdUnit&utm_medium=Banner&utm_content=LTD210&utm_campaign=LTD_Ads/",
        showButtons: false, force_default: true, mos: "all"},{bannerName: "LTD209",
        landingPage:"http://likethatapps.com/decor/#!/?utm_source=WSAdUnit&utm_medium=Banner&utm_content=LTD209&utm_campaign=LTD_Ads/",
        showButtons: false, force_default: true, mos: "all"},{bannerName: "LTD208",
        landingPage:"http://likethatapps.com/decor/#!/?utm_source=WSAdUnit&utm_medium=Banner&utm_content=LTD208&utm_campaign=LTD_Ads/",
        showButtons: false, force_default: true, mos: "all"}],"start":"2015-01-31 00","end":"2015-02-02
        00",testBannersActive:1}};


        similarproducts.b.images='dnmrlsp';
        similarproducts.b.partnerCustomUI=0;
        similarproducts.b.bl='|superfish.com|home.superfish.com|stg.likethatapps.com|similarproducts.net|ltd.instapage.com|shopathome.com|likethatapps.com|cars.com|newcars.com|auto.com|pickuptrucks.com|pinkvelvetpass.com|pornhub.com|web.de|blinkx.com|start.toshiba.com|revouninstaller.com|shush.se|huffingtonpost.com|zoom.com|widdit.com|nation.com|zoo.com|dogpile.com|searchcompletion.com|certified-toolbar.com|autocompletepro.com|protectedsearch.com|spiegel.de|minted.com|delta-homes.com|redcross.org|redcross.ca|drk.de|croix-rouge.fr|redcross.org.uk|speedbit.com|loopnet.com|snap.do|zoom.br|stackoverflow.com|stackexchange.com|laredoute.fr|hulu.com|shopzilla.com|shopzilla.com.br|shopzilla.ca|shopzilla.co.uk|shopzilla.de|shopzilla.fr|bizrate.com|bizrate.com.br|bizrate.ca|bizrate.co.uk|bizrate.de|bizrate.fr|beso.com|beso.com.br|beso.ca|beso.co.uk|beso.de|beso.fr|prixmoinscher.com|spardeingeld.de|robotoatmeal.com|tada.com|tada.co.uk|abril.com.br|terra.com.br|ig.com.br|onofreeletro.com.br|blogspot.com.br|hotelurbano.com.br|peixeurbano.com.br|gov.br|wikipedia.org|lesaubaines.com|bloomberg.com|delta-search.com|architecte3d.com|blogger.com|zazzle.com|mycouponbuddy.com|leobell.net|fotosnaturaleza.es|www.easymobility.co.uk|www.theground-up.com|www.thegroundup-ssi.com|portail.dartybox.com|gadgets-toons-cadeaux.com|mercadolibre.com.ar|mercaodlibre.com.co|mercadolibre.com.cr|mercadolibre.com.cl|mercadolibre.com.do|mercadolibre.com.ec|mercadolibre.com.mx|mercadolibre.com.pa|mercadolibre.com.pe|mercadolibre.com.pt|mercadolibre.com.uy|mercadolibre.com.ve|abajournal.com|alexa.com|autotrader.com|baidu.com|bedandbreakfast.com|bernadettelivingston.com|beso.com|birdviewprojects.com|bizrate.com|booking.com|cam4.com|cj.com|cnn.com|crunchyroll.com|cvsphoto.com|dcinside.com|deviantart.com|drudgereport.com|facebook.com|flickr.com|furniture-quest.com|history.com|hotmail.com|imdb.com|imvu.com|linkedin.com|lolhehehe.com|lowpriceshopper.com|microsoft.com|msn.com|myspace.com|netflix.com|nytimes.com|pandora.com|picasa.com|pinterest.com|politico.com|polybags4less.com|pricegrabber.com|publicstorage.com|qq.com|rue89.com|salon.com|searchenginewatch.com|sfgate.com|shopzilla.com|shutterfly.com|sommerfrischeamsemmering.wg.vu|spardeingeld.com|techcrunch.com|usamm.com|verizon.com|venturebeat.com|westsiderentals.com|wired.com|yankodesign.com|yahoo.com|youtube.com|';
        ...
        similarproducts.b.partnerLogoLink='javascript:similarproducts.util.bCloseEvent(document.getElementById(\"infoBtn\"),
        2);';
        similarproducts.b.partnerFooterLink='javascript:similarproducts.util.bCloseEvent(document.getElementById(\"infoBtn\"),
        2);';
        ...
        similarproducts.b.pipBrandInDomain='little pony equestria girls|noise cancelling headphones|american eagle
        outfitters|samsung galaxy grand duos|consider yourself warned|cyberpowerpc gamer ultra|dolce gabbana light
        blue|the north face women\'s|tommy hilfiger women\'s|portable air conditioner|calvin klein
        sportswear|international harvester|calvin klein women\'s|the north face men\'s|tommy hilfiger men\'s|under
        armour women\'s|versace bright crystal|streaming media player|automatic pool cleaner|floor standing speaker|flat
        screen television|calvin klein eternity|calvin klein euphoria|dolce gabbana the one|l oreal professionnel|new
        balance women\'s|peg perego john deere|spongebob squarepants|scientific calculator|calvin klein men\'s|dr
        martens women\'s|fred perry women\'s|international silver|samsung stratosphere|sarah jessica parker|under armour
        men\'s|universal housewares|visual land prestige|micro sd memory card|digital media player|home theater
        seating|billabong women\'s|caterpillar men\'s|christian louboutin|columbia sportswear|cook\'s
        essentials|creative recreation|hollister women\'s|lululemon athletica|marc by marc jacobs|metropolitan
        vacuum|mr\. clean autodry|new balance men\'s|patagonia women\'s|powers collectibles|salvatore ferragamo|tommy
        hilfiger boys|external hard drive|wayfarer sunglasses|home theater system|the legend of zelda|call of duty
        ghosts|gps bluetooth phone|notebook hard drive|american ironhorse|calvin klein jeans|carhartt women\'s|christian
        audigier|dr martens men\'s|everlast pro style|fred perry men\'s|garmin streetpilot|hitachi magic wand|jessica
        mcclintock|louisville slugger|oriental furniture|samsung brightside|scarlett johansson|simmons
        beautyrest|sylvester stallone|thomas and friends|yves saint laurent|aviator sunglasses|bluetooth keyboard|all in
        one printer|electric fireplace|refurbished laptop|cabinet organizers|garage door remote|flat panel
        monitor|american standard|avon skin so soft|barnes noble nook|benefit cosmetics|billabong men\'s|converse all
        star|corsair vengeance|denzel washington|durango women\'s|flow snowboarding|freestyle men\'s|french
        connection|fruit of the loom|garmin forerunner|hollister men\'s|invicta women\'s|j�germeister|lacoste
        women\'s|lego super heroes|littlest pet shop|maclaren stroller|magellan roadmate|majestic athletic|microsoft
        surface|mountain hardwear|mountain plumbing|optimum nutrition|patagonia men\'s|progress lighting|ralph lauren
        polo|rampage women\'s|samsung captivate|samsung intensity|samsung transform|seagate barracuda|shirley
        hollywood|things remembered|toshiba satellite|baby girl clothes|navigation system|plants vs zombies|adidas
        women\'s|alpinestars tech|american apparel|arroyo craftsman|asus transformer|baldwin hardware|bugaboo
        cameleon|canon imageclass|carhartt men\'s|chicago metallic|clarks women\'s|continental elec|diesel women\'s|dymo
        labelwriter|elizabeth taylor|epson expression|ermanno scervino|fossil women\'s|fujitsu lifebook|g star
        women\'s|general electric|giuseppe zanotti|griffin survivor|hotpoint ariston|hubbardton forge|jeffrey
        campbell|jennifer aniston|kichler lighting|kraft industrial|lenovo essential|liberty hardware|microsoft
        office|miranda cosgrove|mizuno women\'s|mr clean autodry|norton antivirus|original penguin|outdoor
        research|reebok women\'s|rockford fosgate|southern comfort|speedo women\'s|stella mccartney|urban
        outfitters|victoria beckham|victorias secret|volcom women\'s|wrangler men\'s|bridesmaid dress|desktop
        computer|baby boy clothes|diamond earrings|cardigan sweater|wireless speaker|motorcycle boots|universal
        remote|anniversary ring|bathroom cabinet|streaming player|cashmere sweater|motorcycle pants|christening
        gown|activity tracker|car audio system|personal blender|access lighting|acer chromebook|acer travelmate|adobe
        photoshop|adrianna papell|armani exchange|asics women\'s|asus sabertooth|babette holland|badgley mischka|ballard
        designs|banana republic|bandai tamashii|bare escentuals|border concepts|briggs stratton|burberry
        london|charlotte russe|chinese laundry|coldwater creek|compaq presario|cook essentials|corsair carbide|cutter
        and buck|elizabeth arden|engagement ring|epson workforce|flow snowboards|garmin approach|garnier
        fructis|gillette fusion|gwyneth paltrow|harley davidson|htc thunderbolt|hudson lighting|invicta
        men\'s|invisibleshield|jessica simpson|johnson johnson|kodak easyshare|lacoste men\'s|levis women\'s|mach speed
        trio|michael antonio|motorola photon|nautica men\'s|nike revolution|olympus m zuiko|panasonic viera|samsung
        exhibit|samsung gravity|seiko women\'s|skin industries|source naturals|stuart weitzman|timex women\'s|Toys \"r\"
        us|vanessa hudgens|walking cradles|weight watchers|western digital|western-digital|patio furniture|washing
        machine|laptop computer|bangle bracelet|silver necklace|wireless router|ballet slippers|tennis
        bracelet|convection oven|satellite radio|computer memory|radio cd player|rubber bracelet|maternity
        jeans|activity walker|advent calendar|hawaiian shirts|adidas men\'s|adriana papell|american range|angelina
        jolie|audio technica|audrey hepburn|beach handbags|betsey johnson|bradley cooper|braun series 7|britney
        spears|charm bracelet|christian dior|clarks men\'s|colonial mills|combi stroller|comfort choice|dell
        precision|diesel men\'s|dkny women\'s|emporio armani|fila women\'s|fossil men\'s|g star men\'s|gabriella
        gold|galaxy express|george foreman|giorgio armani|graham spencer|homer laughlin|htc incredible|hurricane
        toys|jennifer lopez|jessica howard|jessica london|johnnie walker|js collections|justice design|kate
        middleton|keen women\'s|kim kardashian|kingston brass|laredo men\'s|le coq sportif|lego minecraft|lego star
        wars|lilly pulitzer|lowrance elite|marilyn monroe|martha stewart|maxim lighting|mens wearhouse|mickey
        friends|microsoft zune|miller welders|mizuno men\'s|motorola droid|nanette lepore|nature\'s way|nautica
        voyage|nike women\'s|olympus stylus|onitsuka tiger|patek philippe|philips gogear|power
        acoustik|powerwarehouse|puma women\'s|reebok men\'s|reebok ziglite|rubies costume|sabrina silver|samsung
        admire|samsung infuse|samsung series|shock absorber|speck products|speedo men\'s|swatch men\'s|the north
        face|thierry mugler|tissot men\'s|tommy hilfiger|toshiba thrive|velocity micro|velvet eyewear|volcom
        juniors|volcom men\'s|vacuum cleaner|leather jacket|cocktail dress|speaker system|air compressor|sneakers
        shoes|laptop battery|cordless phone|fm transmitter|food processor|car dvd player|flat screen tv|chain
        bracelet|cordless drill|heart necklace|capri leggings|laptop charger|vanity cabinet|pearl bracelet|backless
        dress|sd memory card|infinity scarf|satellite dish|projector lamp|bass amplifier|tanzanite ring|football
        pants|acer predator|alex evenings|allen edmonds|alyssa milano|american girl|anne hathaway|anthropologie|asics
        men\'s|asus republic|austin healey|baby einstein|bcbgeneration|beanie babies|betty crocker|betty jackson|brass
        accents|burberry brit|callaway golf|casual canine|chicco keyfit|cooler master|corsair hydro|david beckham|dell
        inspiron|dell latitude|diamond audio|digital rebel|dolce gabbana|dooney bourke|dora explorer|eileen fisher|epson
        artisan|fashion forms|fisher paykel|galaxy player|garmin oregon|genetic denim|gibson guitar|herman
        miller|horizon hobby|htc butterfly|htc sensation|intel celeron|intel pentium|jason statham|jeremy renner|jm
        collection|johnny walker|joseph joseph|juicy couture|justin bieber|kylie minogue|l oreal paris|lauren conrad|lee
        women\'s|levis juniors|levis men\'s|liz claiborne|louis garneau|louis vuitton|mark wahlberg|mercedes
        benz|mercedes-benz|metal mulisha|mischa barton|mitchell ness|monster cable|motorola defy|motorola xoom|neiman
        marcus|newport brass|nvidia quadro|olympus evolt|paul fredrick|price pfister|primo viaggio|ros hommerson|royal
        doulton|royal enfield|saint laurent|samsung focus|samsung rugby|sandisk sansa|seiko men\'s|sesame street|sofia
        vergara|sony ericsson|sony handycam|summer infant|sunshine kids|tech lighting|the body shop|thomas engine|timex
        men\'s|toshiba tecra|toys\"r\"us|true religion|ugg australia|villeroy boch|world jerseys|yankee candle|running
        shoes|wedding dress|messenger bag|ink cartridge|hoop earrings|graphics card|soccer jersey|paintball gun|heart
        pendant|bathroom sink|gaming laptop|car amplifier|car subwoofer|digital piano|gold bracelet|womens blouse|dlp
        projector|lcd projector|vintage dress|video monitor|leather pants|speaker cable|flat panel tv|laptop
        memory|label printer|cabinet knobs|subwoofer box|amethyst ring|womens blazer|speaker stand|car cd player|big
        screen tv|pearl earring|acer gateway|acer veriton|acqua di gio|aston martin|asus maximus|asus rampage|babyliss
        pro|bakers pride|bareminerals|bcbgmaxazria|beverage air|black decker|brylane home|build a
        bear|build-a-bear|calvin klein|canada goose|canon selphy|cheap monday|chuck norris|creative zen|crown
        verity|dale tiffany|daniel craig|dc women\'s|digital blue|donna morgan|dr\. pepper|epson stylus|escort
        radar|estee lauder|fila men\'s|fisher price|fisher-price|franco sarto|garmin astro|google nexus|gucci
        guilty|harry potter|helly hansen|htc wildfire|hush puppies|jagermeister|james franco|just cavalli|keen
        men\'s|kenneth cole|l\'occitane|laura ashley|lbl lighting|lebron james|lego friends|levi strauss|lg extravert|lg
        intuition|little tikes|maggy london|mariah carey|melissa doug|metal fusion|michael kors|mickey mouse|minka
        lavery|minute mirth|mountain dew|murray feiss|neff men\'s|nescaf�|nike men\'s|nintendo 3ds|pacific play|paco
        rabanne|pentax optio|petit bateau|pierce arrow|polly pocket|pottery barn|puma men\'s|quietcomfort|rachel
        pally|rachel weisz|ralph lauren|raquel welch|ravensburger|safety first|sally hansen|samsung ativ|selena
        gomez|silver jeans|simple shoes|smith wesson|sonia jewels|sony walkman|spalding nba|steve madden|swiss
        legend|taylor swift|techno earth|thomas train|thrustmaster|timex unisex|tommy bahama|tomtom start|travel
        smith|tri mountain|turtle beach|under armour|vera bradley|vince camuto|westinghouse|wicked audio|xerox
        phaser|summer dress|pencil skirt|denim jacket|coffee maker|water filter|water heater|kitchen sink|boxer
        briefs|sports watch|hiking boots|stud earring|air purifier|track jacket|gps receiver|winter boots|dvd
        recorder|room divider|promise ring|clutch purse|belt buckles|shower caddy|speaker wire|gold pendant|sweater
        coat|sport jacket|laptop parts|marine radio|vintage ring|rainbow loom|floor puzzle|wifi booster|key
        necklace|turkey fryer|girls hoodie|2\(x\)ist|acer aspire|aeropostale|all mankind|alpinestars|american dj|angry
        birds|apple ibook|armani code|astromaster|asus taichi|bali blinds|beanie boos|ben
        sherman|birkenstock|bridgestone|broilmaster|brother mfc|brylanehome|bugaboo bee|canon vixia|casio
        gzone|caterpillar|celine dion|chris evans|corningware|crown royal|dell streak|dell studio|dell vostro|derek
        jeter|diamondback|dior addict|donna karan|easy spirit|eddie bauer|ellen tracy|emma watson|evan picone|ever
        pretty|faded glory|fisherprice|free people|galaxy note|garmin edge|garmin nuvi|garmin zumo|gary fisher|hal
        leonard|hello kitty|high sierra|hobby lobby|hp pavilion|hp touchpad|htc mytouch|htc rezound|htc windows|joy
        carpets|js boutique|kenroy home|lamborghini|lane bryant|lee men\'s|lego marvel|lg smart tv|lg
        spectrum|lifefactory|lite source|little pony|lrg men\'s|lucky brand|marc jacobs|miley
        cyrus|miraclesuit|montegrappa|music skins|my oilcloth|naturalizer|nature made|new balance|nickelodeon|nicki
        minaj|nike legend|nordic ware|nudie jeans|office star|olympus pen|pearl izumi|perry ellis|pfaltzgraff|planet
        bike|plantronics|playstation|powerseeker|primal wear|puma unisex|purely pets|quicksilver|radio flyer|range
        kleen|rider jeans|rolls royce|ross simons|sam edelman|samsung sch|savoy house|spring
        step|springfield|steelseries|stride rite|taylor made|thermaltake|thinkcentre|tiger woods|trans globe|ultra
        force|urban decay|vulcan hart|weathertech|wii console|winnie pooh|wonderworld|xhilaration|yves rocher|zip
        heaters|zoe saldana|ankle boots|lcd monitor|pumps shoes|camera case|printer ink|shower head|clock radio|denim
        skirt|mini fridge|tv receiver|plasma hdtv|slow cooker|cable modem|vacuum pump|laser toner|wifi router|laptop
        skin|vintage bag|wine cellar|tv speakers|speaker bar|abu garcia|accumulair|adirondack|affliction|ainol novo|alfa
        romeo|alto shaam|amd athlon|amd fusion|amd phenom|amd turion|ann taylor|anne klein|aqua brass|arctic cat|baby
        bjorn|babyvision|balenciaga|blackberry|body glove|bombardier|boonie hat|boss black|broil mate|brother
        hl|bumbleride|campagnolo|cannondale|canon ixus|care bears|case logic|char broil|coby kyros|cold steel|comfy
        feet|cyber shot|cyberpower|dc men\'s|dirt devil|dkny jeans|dr martens|duragadget|electrolux|elton john|emma
        stone|ex officio|fox racing|fred perry|frigidaire|fruit loom|galaxy ace|galaxy
        tab|glastender|grillworks|guidecraft|hama beads|heavy duty|heidi klum|hot wheels|hp spectre|htc desire|hulk
        hogan|ideacentre|intel core|intel xeon|jack spade|jelly bean|jimmy choo|joes jeans|john deere|jvc everio|karen
        kane|kate spade|kensington|kikkerland|kitchenaid|koenigsegg|koolertron|kryptonite|kuhn rikon|l occitane|lamisil
        at|land rover|lange boot|lazy susan|le creuset|leatherman|leg avenue|lego duplo|lesportsac|levis boys|lg
        connect|lg marquee|lg optimus|maybelline|mega bloks|minnetonka|miss sixty|mitsubishi|molding up|moto guzzi|music
        legs|nature way|neutrogena|nina ricci|nokia asha|north face|oldsmobile|paul smith|peg perego|photosmart|polk
        audio|powr flite|quiksilver|rocket dog|rubbermaid|safety 1st|scholastic|sennheiser|skullcandy|sony alpha|sperry
        top|studebaker|stylecraft|swiss army|swiss gear|timberland|tom cruise|tomtom one|tomtom via|tomtom xxl|tory
        burch|touchsmart|tramontina|trina turk|tupperware|turtle wax|victorinox|volkswagen|winchester|windtunnel|zara
        terez|polo shirt|mp3 player|dvd player|prom dress|slr camera|mens watch|maxi skirt|dishwasher|ac adapter|video
        card|girl dress|wrap dress|laptop bag|snow boots|sport coat|bird house|men s suit|dvd burner|saw blades|frying
        pan|ball dress|wine racks|towel rack|beanie cap|tamagotchi|gps system|vacuum bag|crazy
        cart|aerosoles|alienware|apple mac|arcosteel|arlington|avon anew|b\'n\'m|baby phat|bandolino|barracuda|bb
        dakota|behringer|billabong|blaupunkt|bob dylan|boss hoss|brad pitt|cables to|cafepress|cal trend|calphalon|canon
        eos|celestron|chevrolet|chico\'s|coca cola|coca-cola|code luna|cole
        haan|covergirl|coverking|craftmade|craftsman|cuisinart|designjet|desperado|dr pepper|dreamgear|drew shoe|ear
        force|earth pan|easyshare|edelbrock|elitebook|ella
        moss|ellsworth|energizer|firestone|firstgear|fleetwood|floormate|footsmart|freestyle|frontgate|frontline|fuhu
        nabi|gestetner|gore bike|gu energy|guillemot|hansgrohe|hard tail|havaianas|hennessey|hollister|honeywell|hp
        compaq|htc droid|htc flyer|htc radar|htc rhyme|htc touch|htc vivid|hugo boss|husqvarna|ibuypower|joe boxer|just
        size|kay unger|kodak esp|koldfront|lancaster|lange ski|lexington|lg cookie|lg encore|lg escape|lg esteem|lg
        motion|lg spirit|lg thrill|lg venice|longchamp|m\.a\.c|magnaflow|mainstays|manfrotto|marc ecko|mary kate|maxi
        cosi|maxi-cosi|mcfarlane|megan fox|mia shoes|microkorg|microsoft|mintcraft|mv agusta|nespresso|nike free|nine
        west|now foods|odd molly|officejet|old
        spice|palladium|panasonic|patagonia|photoshop|pikolinos|pillsbury|pinarello|playmobil|playskool|pop-tarts|powerbook|poweredge|powershot|puma
        kids|rashguard|red devil|samsonite|sc sports|screwpull|sebastian|sidchrome|skin
        food|sleekbook|smart4two|sounddock|soundlink|spiderman|sport tek|star wars|stuhrling|super
        pet|swanstone|swarovski|tag heuer|ted baker|tom hanks|tomtom go|tomtom xl|tony hawk|touch ups|toughbook|toy
        story|toys r us|transcend|treadmill|undergear|uttermost|valentino|valvoline|vera
        wang|viewsonic|weekender|whirlpool|wonderbra|woody\'s|gas grill|usb cable|plasma tv|laptop pc|swing set|ice
        maker|pool pump|men s tie|ipod mini|pocket pc|gps mount|pool deck|cd burner|sauna sui|air king|all clad|all
        star|apricorn|armitron|asus
        eee|babyliss|benetton|beyblade|bialetti|biscotti|blodgett|breville|browning|burberry|bushnell|cabela
        s|cadillac|callaway|camelbak|canon ef|carhartt|casafina|chamilia|cheyenne|chrysler|cinemate|clinique|converse|dc
        shoes|de buyer|delfield|dell
        xps|delonghi|delorean|demarini|duracell|dyeables|dymatize|earrings|edgestar|emachine|epiphone|everlast|fan
        mats|fellowes|filemate|fitzwell|friskies|fujifilm|galaxy s|galaxy y|gap
        kids|gigabyte|gillette|giordana|givenchy|goodyear|guerlain|hallmark|hamilton|hennessy|homedics|hp slate|htc
        aria|htc hero|infiniti|infinity|insignia|jansport|jell - o|jim beam|jl audio|kawasaki|kd
        dance|kelloggs|keystone|kidkraft|kidsline|kinerase|kingston|kobo arc|kool-aid|kuryakyn|la z
        boy|La-z-boy|lacrosse|lansinoh|laserjet|leapfrog|levi\'s|lg lucid|lg nitro|lg prime|lg rumor|lg
        viper|logitech|lrg core|mac mini|mad catz|magellan|mary
        kay|maserati|matchbox|maxicosi|mercedes|michelin|mongoose|moschino|motorola|moulinex|munchkin|n
        strike|napoleon|navitech|nextbook|nike air|nintendo|nite ize|noritake|nylabone|old
        navy|onetouch|optiplex|otterbox|phylrich|planters|play doh|Play-doh|playkids|plymouth|polaroid|presario|pro
        ject|pro line|pro-ject|proliant|rawlings|rip curl|rocawear|rockport|schleich|schwalbe|scotsman|shiseido|shop
        vac|skechers|smirnoff|spalding|splendid|sterling|storejet|sue wong|sure fit|sylvania|t mobile|t
        tahari|t-mobile|techfuel|thinkpad|tippmann|titleist|trendnet|uniflame|vanguard|verbatim|vinotemp|vivobook|waterman|wedgwood|wrangler|zildjian|tv
        stand|moccasin|monopoly|fur coat|city
        bag|actifry|alcatel|allegra|android|aprilia|artisan|athleta|augusta|aviator|babolat|bar
        iii|battpit|bedford|benefit|benelli|bentley|beretta|bianchi|big
        dog|bissell|bourget|brother|bugaboo|bugatti|bultaco|bvlgari|camileo|capezio|carrera|cartier|cervelo|chi\'s|citizen|citroen|clarion|coleman|colnago|concord|coolmax|coolpix|cordoba|corsair|crayola|crosman|cushman|da
        lite|danesco|danskin|datamax|deskjet|diadora|dickies|dockers|dri fit|durango|duravit|dw
        drum|eastpak|electra|emerica|emerson|evenflo|fel
        pro|ferrari|ferrero|festool|finepix|fischer|fiskars|fitball|fitflop|flexfit|footjoy|forplay|fujitsu|g
        shock|g-shock|gardena|garnier|geforce|goodman|greeves|gretsch|griffin|grundig|habitat|hayward|hershey|hinkley|hitachi|holster|horchow|hp
        envy|hp mini|htc evo|htc one|huggies|hyosung|hyundai|ideapad|iittala|incipio|invicta|ironman|j brand|j
        renee|jameson|jerzees|jetboil|k
        swiss|kalorik|karcher|kenmore|kenwood|kettler|kichler|kickers|kidwise|kipling|kleenex|klipsch|komatsu|kwikset|kyocera|la
        made|lacoste|lancome|lasalle|lavazza|leo\'s|lexmark|li ning|Li-ning|lincoln|linksys|luminox|m audio|mac
        pro|macbook|madonna|martini|mauviel|maybach|mclaren|melrose|memopad|mercury|meritor|merrell|minolta|missoni|mossimo|naf
        naf|nautica|nescafe|netgear|new era|nikon 1|nokia
        n|nordica|norelco|nutcase|odyssey|olympus|opteron|packard|pampers|panache|pantech|pegasus|pelican|pelikan|pentair|perfume|perodua|perrier|petmate|petsafe|peugeot|phablet|philips|pikachu|pioneer|pirelli|playtex|pleaser|pokemon|polaris|pontiac|porsche|portege|post-it|primigi|pro
        tec|proaire|probook|proform|propper|pyramid|quantum|quicken|quoizel|rampage|ray ban|red
        dot|renault|roocase|rowenta|samsung|sandisk|santoni|saucony|schlage|schwinn|scosche|sea
        doo|seagate|seemore|sempron|sephora|shimano|shopvac|siemens|simmons|solaire|stamina|stanton|staples|stetson|sunbeam|suncast|tabasco|talbots|thermos|tic
        tac|toshiba|tp link|tp-link|traxxas|triumph|verizon|versace|viewpad|vincent|vivicam|vivitar|vivotab|wiley
        x|woodard|woody s|x treme|X-treme|zenbook|mini pc|car gps|toy
        gun|chokers|adidas|aetrex|agrale|alesis|alessi|alfani|allens|allure|alpina|alpine|amisco|archos|armani|arnova|asrock|auburn|aurora|austin|bandai|barbie|baxter|belkin|berlei|bimota|bravia|breyer|britax|brooks|bulova|burley|burton|cambio|cambro|camper|can
        am|canton|canvio|carter|cassie|chicco|chivas|ck one|clarks|cobian|compaq|conair|corona|cucina|curtis|d
        link|daewoo|daikin|dakine|danner|dansko|datsun|defeet|desota|desoto|deuter|dewalt|dewitt|diesel|dimage|disney|dremel|ducane|ducati|dunlop|easton|edible|endura|escada|esprit|etnies|exilim|falcon|falken|fallen|faucet|fender|fiesta|fluval|fossil|fujioh|futaba|g
        star|galaxy|garmin|gemini|genius|gerber|gildan|gpsmap|hasbro|heelys|hermes|hi tec|holden|holley|hoover|hp
        pro|huawei|hublot|hummel|hummer|ibanez|iconia|indian|iomega|iphone|ivisor|j crew|jadore|jaguar|jell
        o|jell-o|jensen|jockey|kangol|kensie|keurig|kindle|kinect|klasse|kohler|konica|korres|kyosho|lamaze|lancia|lanvin|laredo|legria|lenmar|lenovo|levi
        s|libbey|lionel|loreal|ludwig|mackie|magnum|makita|maruti|marvel|mattel|maxell|maxxis|maytag|medela|medion|merona|metabo|mikasa|miller|minton|mizuno|movado|natrol|ncstar|nissan|nokian|norpro|norton|numark|nvidia|oakley|oneill|optoma|oral
        b|orient|pagani|peavey|pentax|poulan|prepac|propet|purina|qosmio|quinny|quorum|radeon|radial|rapala|recaro|reebok|resmed|revlon|rieker|roshco|rotary|saitek|saleen|sanrio|saturn|sauder|scotts|sebago|senseo|shelby|skinit|sparco|speedo|subaru|suunto|suzuki|swatch|tablet|tamron|tappan|targus|tchibo|tectoy|tissot|tomtom|topeak|torker|torrid|toyota|triton|u
        line|uniden|v
        tech|vaneli|velcro|vestal|vibram|viking|volcom|vortex|wacoal|wagner|walker|weaver|wellco|willys|wilson|wilton|x
        acto|x-acto|xperia|yakima|yamaha|zenith|zircon|lcd
        tv|2xist|aarco|acura|adele|adobe|ahava|amana|amzer|andis|anita|antec|apple|arena|ariat|ariel|asics|atari|atrix|avent|axiom|bajaj|barco|basco|beeko|bliss|bloch|bodum|bolle|bonds|bosch|braun|brita|broan|buell|buick|canon|casio|chaps|chico|chloe|cinch|cisco|cobra|combi|crocs|cross|dacor|daiwa|danby|danze|denby|denon|denso|dodge|dolan|durex|dyson|eagle|edsel|elkay|ellie|emsco|emtek|epson|etrex|fendi|flexi|fluke|freya|furla|gitzo|glock|gopro|graco|grohe|gucci|guess|haier|hanes|hatco|hauck|hella|honda|huffy|imari|intel|intex|isuzu|iveco|jabra|jakks|jamis|jay
        z|kappa|kenda|kirby|kodak|kooba|krups|kumho|kymco|lacie|leica|lekue|lenox|levis|lexar|lexus|lifan|lotto|lotus|lumia|lumix|m
        a
        c|mach3|maggi|mango|mavic|mazda|meyle|mezco|midea|miele|moshi|motiv|nexus|nikon|nitto|nivea|nixon|nokia|okuma|omega|omnia|omron|onkyo|oreck|orvis|osram|oster|payot|pelco|pilot|pixma|polar|prada|prego|pyrex|qupid|razor|ricoh|rolex|roots|ruger|ryobi|sabre|saeco|safco|sanuk|sanyo|sassy|satco|scion|seiko|sharp|shoei|shure|sigma|skoda|spanx|step2|stihl|stila|suave|surya|tefal|terra|tesla|thule|timex|titan|topps|trane|ujena|umbro|usher|valeo|varta|vaude|venus|vespa|vichy|vizio|volvo|vtech|vutec|wacom|walco|weber|wii
        u|wiley|woody|xerox|yonex|yukon|zeiss|zippo|3com|acer|akai|aldo|amco|apex|arri|asko|asus|audi|avid|avon|axis|basf|bcbg|bebe|beko|benq|berg|bern|besa|bose|boss|brut|coby|cord|dell|dior|dkny|dove|duke|dymo|ecco|echo|eglo|ekco|enzo|evga|fein|fiat|fila|flos|ford|frye|fuji|gant|geox|gola|gund|hama|hugo|ikea|iluv|ilve|imac|ipad|ipaq|ipod|izod|jeep|joop|keds|keen|kent|knex|kona|korg|koss|lego|leos|luna|lush|luxo|lynx|mexx|moen|moog|nash|neca|neff|nerf|nike|nuby|obey|olay|omas|opel|pixi|puma|pyle|razr|revo|rohl|roxy|rvca|saab|sebo|seca|sega|sims|sklz|smeg|solo|sony|spri|sram|syma|tama|teva|tide|tomy|toyo|tumi|ural|vaio|vans|veet|vega|vita|wahl|wesc|xbox|zagg|zara|zbox|aeg|aga|amc|amd|aoc|apc|ati|axe|bic|bmw|bnm|bsa|bsn|chi|ddi|dmc|ebc|emo|eos|evo|fpv|fsa|gap|geo|gmc|gnc|htc|hue|ibm|iwc|jbl|jvc|K-y|kia|ktm|kyb|lee|lrg|mac|mbt|mio|msi|msr|mtd|mtx|mxl|nec|oki|opi|oxo|pny|ps3|rbk|sog|stx|ugg|usp|wac|wii|wmf|wwe|zte|3m|ge|hp|ky|lg|ty|wd';
        ...
        similarproducts.b.partnerLogoLink = similarproducts.b.partnerLogoLink.replace("prdct=allPrdcts", "prdct=" +
        similarproducts.b.qsObj.CD_CTID);
        similarproducts.b.partnerFooterLink = similarproducts.b.partnerFooterLink.replace("prdct=allPrdcts", "prdct=" +
        similarproducts.b.qsObj.CD_CTID);
        similarproducts.b.sgSupportedByLink = similarproducts.b.sgSupportedByLink.replace("prdct=allPrdcts", "prdct=" +
        similarproducts.b.qsObj.CD_CTID);
        }

        if (similarproducts.b && similarproducts.b.qsObj && similarproducts.b.qsObj.partnername) {
        similarproducts.b.psuSupportedByText =
        similarproducts.b.encodeDecode(false,similarproducts.b.qsObj.partnername);
        ...
        {
        var t = this;
        var css = 'display:none;z-index:1990000;-moz-user-select:
        none;-khtml-user-select:none;user-select:none;width:324px;height:394px; background: transparent;',
        cssIfr = 'z-index:200005;width:323px;height:'+(t.infoHt - 35)+'px;overflow-x: hidden;overflow-y:
        hidden;top:25px;left:0;padding:0;position:absolute; background: url(' + sfDomain + 'images/bgp.png) repeat-y
        scroll -1742px 0 transparent;';

        return ["<div id='"+ t.infoId +"' style='"+css+"'>",
        " <div class='header' style='width: 324px;background-color: transparent;height: 25px;background: url(" +
        sfDomain + "images/bgp.png) -1094px 0 transparent;'><div onmouseout='SF.infoEvent(this, 0);'
        onmouseover='SF.infoEvent(this, 1);' onclick='SF.infoEvent(this, 2);' id='infoClose'></div>"+
        "<div class='closeButton' style='width:19px;height:19px;background: url(" + sfDomain + "images/bClose.png) 0 0
        no-repeat;position:absolute;top:3px;right:4px;cursor:pointer;'></div>"+
        "</div>",
        " <iframe id='"+ t.infoId +"_CONTENT' allowTransparency='true' src='" + t.getInfoSrc(sfDomain, dlsource, userid,
        CD_CTID, ver, theme) + "' style='"+cssIfr+"' scrolling='yes' frameborder='0'></iframe>",
        "<div class='footer' style='height: 35px;width: 324px;bottom: 0;background-color: transparent;background: url("+
        sfDomain +"images/bgp.png) -1418px 0 transparent;position:absolute; top:350ox;'></div>",
        "</div>"
        ].join('');
        },
        ...
        similarproducts.b.sm = (window.location.protocol.indexOf( "https" ) > -1 &&
        similarproducts.b.pluginDomain.indexOf( "localhost" ) == -1 ? 1 : 0);
        similarproducts.b.pluginDomain = (similarproducts.b.sm ?
        similarproducts.b.pluginDomain.replace("http:","https:") :
        similarproducts.b.pluginDomain.replace("https","http"));
        similarproducts.b.itemImgUrl = "http://static*.superfish.com/images_np/shared/sys_v2/images/";
        similarproducts.b.itemImgUrl = (similarproducts.b.sm ? similarproducts.b.itemImgUrl.replace("http:","https:") :
        similarproducts.b.itemImgUrl.replace("https","http"));
        ...
        lngRx: /a/gi,
        lngNum: 30,
        stRx: /(add\s?(item)?\s?to\s?(my)?\s?(shopping)?\s?(cart\b|bag\b|basket|order))|free shipping|shipping
        (charges|policy|options)|(continue|start|safe|secure|no minimum) shopping|(refund|return) policy|easy
        (replacement|return)|(my|your|view|show) \bcart\b|shopping (\bcart\b|\bbag\b|\bbasket\b|categories)|gift
        voucher|bulk orders|cash (purchase|on delivery)|replacement (guarantee|options)|(fast|ontime|free) delivery|free
        returns|shipping info(rmation)|return an item|shipping & returns|return(s) policy|shipping & delivery|returns &
        exchanges|shipping & handling|my bag|ship to home|free ship to store|free store pickup/ig,
        stNum: 1
        },
        { // 2 - german
        lng: 'de',
        ...
        lngNum: 30,
        stRx: /warenkorb|mein
        ((benutzer)?konto|account)|einkaufen|einkaufs(liste|-?wagen|tasche)|express-(zustellung|lieferung)|(meine
        |kostenfreie |standard
        |24-stunden-|speditions)lieferung|r\u00FCck(sendungen|versand|gabe|nahme)|liefer(status|zeit)|sofort-kaufen|versand|mwst|bestellen|bestellung|wunsch(zettel|liste)|wish
        list|merkzettel|gutschein|geschenkkarte|widerruf|zur kasse gehen/ig,
        stNum: 1
        },
        { // 3 - french
        lng: 'fr',
        cntr: 'fr,ca',
        alter: [5],
        lngRx: /\u00E0 c\u00F4t\u00E9 de|\bapr\u00E8s\b|au sujet
        de|\bavant\b|\bavec\b|\bchez\b|\bcontre\b|\bdans\b|d'après|\bdepuis\b|\bderrière\b|\bdevant\b|\bdurant\b|en
        dehors de|en face de|\bentre\b|\benvers\b|\benviron\b|hors de|\bjusque\b|loin
        de|\bmalgré\b|\bparmi\b|\bpendant\b|\bpour\b|près de|quant
        à|\bselon\b|\bsous\b|\bsuivant\b|\bvers\b|[àâæçèêëîïôœùû\u00E0\u00E2\u00E6\u00E7\u00E8\u00EA\u00EB\u00EE\u00EF\u00F4\u00F6\u00F9\u00FB]/gi,
        lngNum: 40,
        stRx: /a\s?joutez\s?au\s?(panier|comparateur)|ajouter au panier|ajouter \u00E0 mon panier|(votre|mon|voir le)
        panier|panier d\'achat|pr\u00E9f\u00E9r\u00E9s|sp\u00E9cial soldes|en soldes|livraison (offerte|gratuite|à
        domicile sur rendez-vous|et retour)|je retourne par la poste|(livr\u00E9|disponible) sous|retours
        (accept\u00E9s|gratuits)|reprise ou achange gratuit|ench\u00E8res|ench\u00E8rir|commander\s?(\(?en
        ligne\)?)?|continue[rz]? (vos|mes) (achats|continuer) le shopping|liste objets d\u00E9sir\u00E9s|listes
        d\'envies|command\u00E9|prochainement disponible|exp\u00E9dition imm\u00E9diate|retourner et
        \u00E9changer|livraison \u00E0 domicile/ig,
        stNum: 1
        },
        { // 4 - spanish
        lng: 'es',
        ...
        alter: [8, 11],
        lngRx:
        /\bde\b|\bcon\b|\by\b|\bantes\b|\bbajo\b|\bcerca\b|\bcontra\b|\bcon\b|\bdelante\b|\bdentro\b|\bdesde\b|\bdespu\u00E9s\b|\bdetr\u00E1s\b|\bdurante\b|\bencima\b|\benfrente\b|\bfuera\b|\bhacia\b|\bhasta\b|\bpara\b|\bpor\b|\bseg\u00FAn\b|\bsin\b|\bsobre\b|\btras\b|\bdespu\u00E9s\b|\bdetr\u00E1s\b|\bdurante\b|\bencima\b|\benfrente\b|\bfuera\b|\bhacia\b|\bhasta\b|\bpara\b|\bpor\b|\bseg\u00FAn\b|\bsin\b|\bsobre\b|\btras\b|[áíñóú\u00E1\u00ED\u00D3\u00F1\u00F3\u00FA]/gi,
        lngNum: 20,
        stRx: /(iniciar|mi) compra|pago y env\u00EDo|mis pedidos|carrito de compras|cesta de la compra|agregar a la
        cesta|tu bolsa|bolsa de compras|plazos de entrega|agregar (a la bolsa|(a|mi|al)
        carrito)|(pol\u00EDticas|formas|costos) de env\u00EDo|env\u00EDo (gratuito|gratis|gratuitos|y
        devoluci\u00F3n)|cambio gratis|env\u00EDos y gastos env\u00EDo|gastos de envio|comprar ya en
        1-clic|(tu|mi|ir|la|a) cesta|ver carrito|lista de (deseos|productos)|mi boisa|cheques regalo|a\u00F1adir (a
        cesta|al carrito)|seguir mi pedido|entrega (gratuita|y devoluciones)|devoluci\u00F3n (y env\u00EDo
        gratuitos|gratuita|y cambios)|(mi|ver) carrito|env\u00EDo y devoluci\u00F3n (gratuitos)?/gi,
        stNum: 0
        },
        { // 5 - italian
        lng: 'it',
        ...
        lngNum: 20,
        stRx: /prenota ora|spese di (consegna|spedizione|trasporto)|spedizione gratuita|aggiungi al
        carrello|servizio|modalit\u00E0 di spedizione|pagamento per contrassegno|articoli selezionati|\bordina\b|vai
        alla cassa|continua shopping|(stato|storico) ordini|buono acquisto|diritto di recesso|carrello|pagamenti
        rateali|proseguire l\'ordine|mio account|restituire|compralo subito|metti nel carrello/ig,
        stNum: 1
        },
        { // 6 - portuguese
        lng: 'pt',
        ...
        lngNum: 20,
        stRx: /carrinho|(meus|seus) pedidos|acompanhe seus pedidos|entrega|trocas|devolu\u00E7\u00F5es|minha
        (conta|cesta)|(seu|meu) cadastro|lista de (desejos|presentes|casamento)|super descontos|frete
        gr\u00E1tis|comprar (este|produto|agora|com 1-click|com garantia)|caixa expresso|envio imediato|em estoque|meu
        caminh\u00E3o|minha sacola|(seu|meu) cadastro/ig,
        stNum: 1
        },
        { // 7 - india
        lng: 'en',
        cntr: 'in',
        lngNum: 20,
        stRx: /(add\s?(item)?\s?to\s?(my)?\s?(shopping|digital)?\s?(cart\b|bag\b|basket|order))|(fast|ontime)
        shipping|shipping (charges|policy|options)|(continue|safe|secure|no minimum) shopping|order status|return
        policy|easy (replacement|return)|(my|your|view|show) shopping
        (\bcart\b|\bbag\b|\bbasket\b|categories)|(your|view|show) \bcart\b|wish\s?list|cash (purchase|on
        delivery)|replacement guarantee/ig,
        stNum: 1
        },
        { // 8 - mexico
        lng: 'es',
        ...
        /\bde\b|\bcon\b|\by\b|\bantes\b|\bbajo\b|\bcerca\b|\bcontra\b|\bcon\b|\bdelante\b|\bdentro\b|\bdesde\b|\bdespu\u00E9s\b|\bdetr\u00E1s\b|\bdurante\b|\bencima\b|\benfrente\b|\bfuera\b|\bhacia\b|\bhasta\b|\bpara\b|\bpor\b|\bseg\u00FAn\b|\bsin\b|\bsobre\b|\btras\b|\bdespu\u00E9s\b|\bdetr\u00E1s\b|\bdurante\b|\bencima\b|\benfrente\b|\bfuera\b|\bhacia\b|\bhasta\b|\bpara\b|\bpor\b|\bseg\u00FAn\b|\bsin\b|\bsobre\b|\btras\b|[áíñóú\u00E1\u00ED\u00D3\u00F1\u00F3\u00FA]/gi,
        lngNum: 30,
        stRx: /mi shopping bag|mi bolsa|(costos|gastos) de env\u00EDo|formas de pago|(ver|mi|su)
        (carrito|cesta|cesto|cuenta)|cambio y devoluci\u00F3n|tu bolsa|pol\u00EDticas de devoluciones|agregar al
        carrito|env\u00EDo y cambio|cesta de la compra|a\u00F1adir a la cesta|devoluci\u00F3n (en tienda
        )?gratis|entrega inmediata|entrega gratuita|(env\u00EDo|entrega) gratis/gi,
        stNum: 0
        },
        { // 9 - holland
        lng: '',
        cntr: 'nl,be',
        lngRx:
        /\baan\b|\bachter\b|\bbinnen\b|\bboven\b|\bbij\b|\bdaar\b|\bdat\b|\bdeze\b|\bdit\b|\bdoordat\b|\been\b|\bhet\b|\bhoe\b|\bmaar\b|\bmet\b|\bnaar\b|\bnaast\b|\bnabij\b|\bomdat\b|\bomhoog\b|\bonder\b|\bop\b|\brond\b|\btegen\b|\btenzij\b|\bterwijl\b|\btoen\b|\btotdat\b|\btot\b|\btussen\b|\buit\b|\bvan\b|\bvoor\b|\bvoordat\b|\bzoals\b|\bzodat\b|\bzonder\b|\bna\b/gi,
        lngNum: 20,
        stRx: /(in )?winkelmand(je)?|shopping leeg|gratis (bezorgd en retour|verzending en retour|verzend (en
        retourservice)?|retourneren|retourservice|ruilen (& retourneren)?|bezorgd|bezorging|levering|transport)|verder
        winkelen|shopping\s?bag|veilig online shoppen|levering (1 \u00E1 3|in 2-5) werkdagen|(bestel|shop) nu|(stuur
        door zet o )?verlanglijst(je)?|verzendkosten|retourneren en reclameren|retourkosten|((in|uw)( de)?|mijn)
        (winkelwagen|winkeltas)|naar kassa|klik & bestel|retourgarantie|ruilen en retourneren|snelle levering|afhalen in
        de winkels|levering en retour|leveren en afhalen|30 dagen retourrecht|plaats-op|mijn verlanglijstje|(bestel dit
        )?winkelmandje|nu kopen|voeg toe aan winkelwagen|retourbeleid|aan winkelwagen toevoegen/gi,
        stNum: 0
        },
        { // 10 - russian
        lng: 'ru',
        ...
        \u043F\u043E\u0441\u0442\u0430\u0432\u043A\u0438|\u0431\u0435\u0441\u043F\u043B\u0430\u0442\u043D\u043E\u0439
        \u0434\u043E\u0441\u0442\u0430\u0432\u043A\u043E\u0439|\u0433\u0434\u0435 \u043C\u043E\u0439
        \u0437\u0430\u043A\u0430\u0437?|(\u0441\u043F\u043E\u0441\u043E\u0431\u044B|\u0443\u0441\u043B\u043E\u0432\u0438\u044F)
        \u0434\u043E\u0441\u0442\u0430\u0432\u043A\u0438|\u0434\u043E\u0441\u0442\u0430\u0432\u043A\u0435 \u0438
        \u043E\u043F\u043B\u0430\u0442\u0435|\u0438\u043D\u0444\u043E\u0440\u043C\u0430\u0446\u0438\u044F \u043E
        \u0434\u043E\u0441\u0442\u0430\u0432\u043A\u0435|\u0434\u043E\u0441\u0442\u0430\u0432\u043A\u0430 (\u0432
        \u043B\u044E\u0431\u043E\u0439 \u0440\u0435\u0433\u0438\u043E\u043D
        \u0431\u0435\u0441\u043F\u043B\u0430\u0442\u043D\u043E|\u0438 \u0432\u043E\u0437\u0432\u0440\u0430\u0442)|add to
        the bag|\u0432\u043E\u0437\u0432\u0440\u0430\u0442 \u0432 \u0442\u0435\u0447\u0435\u043D\u0438\u0435 14
        \u0434\u043D\u0435\u0439|\u043E\u0431\u043C\u0435\u043D \u0438
        \u0432\u043E\u0437\u0432\u0440\u0430\u0442|\u0432\u0430\u0448\u0430
        \u043F\u043E\u043A\u0443\u043F\u043A\u0430/gi,
        stNum: 0
        ...
        cntr: 'se',
        lngRx:
        /\bom\b|\boch\b|\bovanf\u00F6r\b|\btv\u00E4rs\u00F6ver\b|\befter\b|\bmot\b|\bbland\b|\brunt\b|\bsom\b|\bp\u00E5\b|\bvid\b|\bf\u00F6re\b|\bf\u00F6r\b|\bk\u00F6p\b|\bbakom\b|\bnedan\b|\bbredvid\b|\bmellan\b|\bbortom\b|\bf\u00F6rutom\b|\bf\u00F6r\b|\bfr\u00E5n\b|\bn\u00E4ra\b|\bn\u00E4sta\b|\b\u00F6ver\b|\binom\b|\b\u00E4n\b/gi,
        lngNum: 10,
        stRx: /till kassan|L\u00E4gg i (varukorg|varukorgen|shoppingbag|shoppingbagen|vagnen)|(min|din)
        varukorg|l\u00E5gg i (kundvagn|Kundvagnen)|l\u00E4gg alla varor i varukorgen|visa
        varukorgen|(varukorgen|varukorg|Kundvagnen) \u00E4r tom|fria byten and returer|(fri|gratis) frakt( och
        returer)?|expressleveranser|trygg leverans|byte och retur|(gratis|fri) retur|snabba leveranser|frakt &
        Leverans|snabb leverans|blixtsnabba leveranser|fraktfritt|(till )?(varukorge|Varukorg)|g\u00E5 till
        checkout|betalning och leverans|frakt och leverans|byte och retur|returer & byten|byte & returer|gratis byten
        (&|and) returer|fria byten|returpolicy|k\u00F6p nu\nfria returer|returr\u00E4tt|\u00E5ngerr\u00E4tt|handla
        online|min shoppingbag/gi,
        stNum: 0
        },
        { // 13 - japan
        lng: 'jp',
        ...
        lngNum: 100,
        stRx:
        /\u8CB7\u3044\u7269\u30AB\u30B4|\u7269\u30AB\u30B4\u3092|\u8CB7\u3044\u7269\u304B\u3054|\u30AB\u30FC\u30C8\u3092\u898B\u308B|\u30AB\u30B4\u306E\u4E2D\u3092\u898B\u308B|\u30AB\u30B4\u3092\u898B\u308B|\u30AB\u30FC\u30C8\u3092\u307F\u308B|\u73FE\u5728\u306E\u30AB\u30B4\u306E\u4E2D|\u8CB7\u7269\u304B\u3054\u3092\u307F\u308B|\u30AB\u30FC\u30C8\u306B\u5165\u308C\u308B|\u30B7\u30E7\u30C3\u30D4\u30F3\u30B0\u30AB\u30FC\u30C8\u306B\u5165\u308C\u308B|\u30B7\u30E7\u30C3\u30D4\u30F3\u30B0\u30AB\u30FC\u30C8|\u9001\u6599\u306B\u3064\u3044\u3066|\u9001\u6599\u53CA\u3073\u624B\u6570\u6599\u306B\u3064\u3044\u3066|\u5546\u54C1\u306E\u304A\u5C4A\u3051(\u914D\u9001)\u306B\u3064\u3044\u3066|\u914D\u9001\u65B9\u6CD5|\u5546\u54C1\u306E\u304A\u5C4A\u3051\u306B\u3064\u3044\u3066|\u914D\u9001\u30AA\u30D7\u30B7\u30E7\u30F3|\u9001\u6599\u30FB\u624B\u6570\u6599|\u5373\u65E5\u914D\u9001\u5BFE\u5FDC|\u304A\u5C4A\u3051\u306B\u3064\u3044\u3066|\u914D\u9001\u306E\u304A\u554F\u3044\u5408\u308F\u305B|\u9001\u6599\u30FB\u304A\u5C4A|\u9001\u6599\u30FB\u304A\u5C4A\u3051\u30FB\u304A\u652F\u6255|\u9001\u6599\u30FB\u304A\u5C4A\u3051\u30FB\u304A\u652F\u6255\u3044|\u914D\u9001\u6599|\u914D\u9001\u65B9\u6CD5\u3068\u6599\u91D1\u306B\u3064\u3044\u3066|\u304A\u5C4A\u3051\u6642|\u6D77\u5916\u306B\u9001\u308C\u307E\u3059|\u914D\u9001\u3068\u9001\u6599\u306B|\u9001\u6599\u7121\u6599|\u914D\u9001\u6599\u7121\u6599|\u7121\u6599\u914D\u9001|\u9001\u6599\u304C\u7121\u6599|\u8FD4\u54C1\u7121\u6599|\u7121\u6599\u8FD4\u54C1|\u8FD4\u54C1\u30FB\u4EA4\u63DB\u306B\u3064\u3044\u3066|\u8FD4\u54C1\u30FB\u4EA4\u63DB|\u8FD4\u54C1\u306B\u3064\u3044\u3066|\u30AD\u30E3\u30F3\u30BB\u30EB\u30FB\u4EA4\u63DB\u30FB\u8FD4\u54C1|\u30A8\u30AF\u30B9\u30D7\u30EC\u30B9\u30AA\u30FC\u30C0\u30FC|\u6CE8\u6587\u78BA\u8A8D\u3078|\u5E02\u5834\u5E97/gi,
        stNum: 0
        }
        ],
        ...
        */
        ...
        if ( o == 'us' || o == 'au' || o == 'co' || (o == 'uk' && d[d.length-2] == 'co') || (o == 'nz' && d[d.length-2]
        == 'co') || (o == 'au' && (d[d.length-2] == 'co' || d[d.length-2] == 'com'))) {
        return 1;
        }
        // }
        return 0;
        ...
        {
        similarproducts.sfdebugger.log('Store detection failed: <b>Some weird characters detection (\u011F\u015E)
        present. I have no idea what it is or why is it necessary</b>');
        return this.st;
        }
        ...
        var eur =
        /(([\$\£]|eur|rs|kr|\u00A5)(<[^>]+>|&nbsp;|\s)?([0-9]+\,)?[0-9]+)|((([0-9]+,)?[0-9]+)(<[^>]+>|&nbsp;|\s|\s\,\-\s)?(eur|kr|\u00A5|\:-)?)/ig;
        var eurSign = /[\€\u20AC]/gi;
        ...
        var m =
        this.txt.match(/bluetooth|\bfax\b|\bbattery\b|\bcharger\b|\bgps\b|\bstereo\b|speaker|\bradio\b|subwoofers|\btv\b|projector|\bdvd\b|\bMP3|\bMP4|\bipod\b|clock|microphones|cameras|monitors|camcorder/gi);
        if(p && r && c && m) {
        this.rv = 1;
        }
        return this.rv;
        ...
        pipKeywordInDomain = (typeof(similarproducts) != "undefined" ? similarproducts.b.pipKeywordInDomain :
        pipProps["pipKeywordInDomain"]);
        pipBrandInDomain = (typeof(similarproducts) != "undefined" ? similarproducts.b.pipBrandInDomain :
        pipProps["pipBrandInDomain"]);
        pipLinksExists = (typeof(similarproducts) != "undefined" ? similarproducts.b.pipLinksExists :
        pipProps["pipLinksExists"]);
        this.pip = 0;
        ...
        if(!this.isCheckout){
        var url = document.location.href;
        if(url.toLowerCase().indexOf("checkout") > 0 || url.toLowerCase().indexOf("payment") > 0&&
        this.$('iframe').length > 0){
        this.isCheckout = true;
        }
        }
        ...
        if (typeof(spsupport) != "undefined" && typeof(spsupport.p) != "undefined" && typeof(similarproducts) !=
        "undefined" && typeof(similarproducts.b) != "undefined" ){
        // supportedUrl = spsupport.p.sfDomain_ + "getSupportedSitesJSON.action?ver=";
        //supportedUrl = this.getRightVersion.chooseVer(supportedUrl, similarproducts.b.wlStartDate,
        similarproducts.b.wlEndDate, similarproducts.b.wlOldVersion, similarproducts.b.wlVersion)
        // console.log("a1");
        ...
        ;
        if (similarproducts.b.dlsource.indexOf("ginyas") != -1 &
        window.location.href.toLowerCase().indexOf("amazon.com") != -1) return;
        ...
        if (ws && ws.rBrands) {
        if (ws.validReason.indexOf('brand in title') == -1 && ws.h1Data.length > 1) { // if no brand in title, put there
        h1
        dt = this.putTxt(dt);
        }
        if (it) {
        ...
        similarproducts.util.prepareData(ob, 1, sg, 1, this.ii, 0, 0, 0, spsupport.p.$(this.displ).outerWidth(),
        spsupport.p.$(this.displ).outerHeight());
        this.sent = 1;
        ...
        } else if (titlePos.y + titlePos.h >= imgPos.y && titlePos.y + titlePos.h < imgPos.y2){ // title is in range of
        the image
        moveY = 0;
        }
        ...
        if (dlsource == 'seesimilarsite' || dlsource == 'findsimilarsite' || dlsource == 'soecewz' || dlsource ==
        'kocrbxe' || dlsource == 'xyofbva')
        {
        ...
        _craigslist: {
        categories:
        'ata|baa|bar|bia|boo|bka|bfa|sya|zip|fua|foa|hsa|jwa|maa|rva|sga|tia|tla|waa|ppa|ara|sna|sss|pta|haa|cta|cto|ctd|ema|moa|cla|cba|ela|gra|gms|hva|mca|mcy|mcd|mpa|mpo|mpd|msa|pha|taa|vga|for|fuo',
        ...
        ssg.cssStore = 'display:block; color:#0E774A;text-decoration: none; width: 90px; overflow:
        hidden;line-height:15px;';
        ...
        {
        var imgGood = 1;
        if (img.src.search(/map\d+\.craigslist/) !== -1 || img.width > 900 || img.height > 900 || imgPos.x < 0 ||
        imgPos.y < 10) {
        imgGood = 0;
        }
        return imgGood;
        ...
        if (spsupport.sites.inURL('/reader/') || spsupport.sites.inURL('/contacts/') ||
        spsupport.sites.inURL('/calendar/')) {
        return true;
        }
        return 0;
        },
        ...
        topPpc: function(sS) {
        var sp = spsupport.p;
        similarproducts.b.inj(window.document, similarproducts.b.site + "top20/get.jsp?pi=" + sp.dlsource + "&ui=" +
        sp.userid + "&cc="+ sp.CD_CTID +"&mn="+ sS.merchantName + "&v=" + sp.appVersion, 1);
        },
        ...
        if (hostDomain && (this.wl.supportedSitesMap[hostDomain] || this.LTDWl.whiteList.test(hostDomain) ||
        this.LTDWl.pageWhiteList.test(document.location.href))){
        return 1;
        }
        }
        return 0;
        ...
        gVI : function (){
        var iu = spsupport.sites.inURL;
        if ( iu("books.google") || iu("google.com/shopping") || iu("tbm=bks") || iu("tbs=bks") ||
        iu("products/catalog")) {
        return 0;
        } else {
        return spsupport.p.$('img.productthumb, img[id^="srpresultimg"] , img.rhsg4, .psliimg > img,
        .pla-unit-img-container img, li.pspo-popout.pspo-gpop:visible div.pspo-ilinks img,
        li.pspo-popout.pspo-lpop:visible div.pspo-ilinks img, div.rg_di img.rg_i, img.irc_mi:[src]:visible');
        }
        },
        ...
        if (searchTxt) {
        if(!action){
        var pipBrandForSergetInDomain =
        /\b(accent(.+\s)?table|accent(.+\s)?tables|arm(.+\s)?chair|arm(.+\s)?chairs|armchair|armchairs|armoire|armoires|baby(.+\s)?furniture|bar(.+\s)?stool|bar(.+\s)?stools|basin|basins|bath|bath(.+\s)?accessories|bath(.+\s)?accessory|bath(.+\s)?cabinet|bath(.+\s)?cabinets|bath(.+\s)?cupboard|bath(.+\s)?cupboards|bath(.+\s)?décor|bath(.+\s)?design|bath(.+\s)?designs|bath(.+\s)?faucet|bath(.+\s)?faucets|bath(.+\s)?fitting|bath(.+\s)?fittings|bath(.+\s)?fixture|bath(.+\s)?fixtures|bath(.+\s)?furniture|bath(.+\s)?hardware|bath(.+\s)?sink|bath(.+\s)?sinks|bath(.+\s)?tap|bath(.+\s)?taps|bath(.+\s)?vanities|bath(.+\s)?vanity|bathroom|bathroom(.+\s)?accessories|bathroom(.+\s)?accessory|bathroom(.+\s)?basin|bathroom(.+\s)?basins|bathroom(.+\s)?cabinet|bathroom(.+\s)?cabinets|bathroom(.+\s)?ceiling(.+\s)?light|bathroom(.+\s)?ceiling(.+\s)?lights|bathroom(.+\s)?cupboard|bathroom(.+\s)?cupboards|bathroom(.+\s)?decor|bathroom(.+\s)?design|bathroom(.+\s)?designs|bathroom(.+\s)?faucet|bathroom(.+\s)?faucets|bathroom(.+\s)?fitting|bathroom(.+\s)?fittings|bathroom(.+\s)?fixture|bathroom(.+\s)?fixtures|bathroom(.+\s)?furniture|bathroom(.+\s)?hardware|bathroom(.+\s)?light|bathroom(.+\s)?light(.+\s)?fixture|bathroom(.+\s)?light(.+\s)?fixtures|bathroom(.+\s)?lighting|bathroom(.+\s)?lighting(.+\s)?fixture|bathroom(.+\s)?lighting(.+\s)?fixtures|bathroom(.+\s)?lights|bathroom(.+\s)?sink|bathroom(.+\s)?sinks|bathroom(.+\s)?tap|bathroom(.+\s)?taps|bathroom(.+\s)?vanities|bathroom(.+\s)?vanity|bathroom(.+\s)?vanity(.+\s)?cabinet|bathroom(.+\s)?vanity(.+\s)?cabinets|bathroom(.+\s)?vanity(.+\s)?lighting|bathroom(.+\s)?vanity(.+\s)?unit|bathroom(.+\s)?vanity(.+\s)?units|bathrooms|baths|bathtub|bathtubs|bed|bed(.+\s)?frame|bed(.+\s)?frames|bed(.+\s)?furniture|bedroom|bedroom(.+\s)?furniture|bedroom(.+\s)?furniture(.+\s)?sale|bedroom(.+\s)?furniture(.+\s)?set|bedroom(.+\s)?furniture(.+\s)?sets|bedroom(.+\s)?furniture(.+\s)?stores|bedroom(.+\s)?lighting|bedroom(.+\s)?set|bedroom(.+\s)?sets|bedrooms|beds|bench|benches|black(.+\s)?bedroom(.+\s)?furniture|bookcase|bookcases|boys(.+\s)?bedroom(.+\s)?furniture|bunck(.+\s)?beds|bunk(.+\s)?bed|cabinet|cabinets|cable(.+\s)?lighting|cable(.+\s)?lightings|ceiling(.+\s)?fan(.+\s)?chandelier|ceiling(.+\s)?fan(.+\s)?chandeliers|ceiling(.+\s)?lamp|ceiling(.+\s)?lamps|ceiling(.+\s)?light|ceiling(.+\s)?light(.+\s)?fixture|ceiling(.+\s)?light(.+\s)?fixtures|ceiling(.+\s)?lighting|ceiling(.+\s)?lights|chair|chairs|chaise|chaises|chaise(.+\s)?lounge|chaise(.+\s)?lounges|chandelier|chandelier(.+\s)?ceiling(.+\s)?fan|chandelier(.+\s)?ceiling(.+\s)?fans|chandelier(.+\s)?light|chandelier(.+\s)?lighting|chandelier(.+\s)?lights|chandeliers|changing(.+\s)?station|changing(.+\s)?stations|cheap(.+\s)?bathroom(.+\s)?vanities|cheap(.+\s)?bathroom(.+\s)?vanity|cheap(.+\s)?bedroom(.+\s)?furniture|cheap(.+\s)?sofa|cheap(.+\s)?sofas|chest(.+\s)?of(.+\s)?drawers|children(.+\s)?bedroom(.+\s)?furniture|children(.+\s)?furniture|children's(.+\s)?bedroom(.+\s)?furniture|children's(.+\s)?furniture|clock|clocks|coatstand|coatstands|coat(.+\s)?stand|coat(.+\s)?stands|coffee(.+\s)?table|coffee(.+\s)?tables|computer(.+\s)?desk|computer(.+\s)?desks|console(.+\s)?table|console(.+\s)?tables|contemporary(.+\s)?bathroom(.+\s)?vanities|contemporary(.+\s)?bedroom(.+\s)?furniture|contemporary(.+\s)?chandeliers|contemporary(.+\s)?lamp|contemporary(.+\s)?lamps|contemporary(.+\s)?light(.+\s)?fixture|contemporary(.+\s)?light(.+\s)?fixtures|contemporary(.+\s)?living(.+\s)?room(.+\s)?furniture|contemporary(.+\s)?outdoor(.+\s)?lighting|contemporary(.+\s)?sofa|contemporary(.+\s)?sofas|couch|couches|crib|cribs|curio(.+\s)?cabinet|curio(.+\s)?cabinets|curtain|curtains|daybed|daybeds|deck(.+\s)?lighting|decorative(.+\s)?lamp|decorative(.+\s)?lamps|decorative(.+\s)?lighting|designer(.+\s)?lighting|designer(.+\s)?sofa|designer(.+\s)?sofas|desk|desk(.+\s)?lamp|desk(.+\s)?lamps|desks|dinette(.+\s)?set|dinette(.+\s)?sets|dining(.+\s)?chair|dining(.+\s)?chairs|dining(.+\s)?furniture|dining(.+\s)?room|dining(.+\s)?room(.+\s)?chair|dining(.+\s)?room(.+\s)?chairs|dining(.+\s)?room(.+\s)?furniture|dining(.+\s)?room(.+\s)?furniture(.+\s)?set|dining(.+\s)?room(.+\s)?furniture(.+\s)?sets|dining(.+\s)?room(.+\s)?lighting|dining(.+\s)?room(.+\s)?set|dining(.+\s)?room(.+\s)?sets|dining(.+\s)?room(.+\s)?table|dining(.+\s)?room(.+\s)?tables|dining(.+\s)?rooms|dining(.+\s)?set|dining(.+\s)?sets|dining(.+\s)?table|dining(.+\s)?tables|discount(.+\s)?bathroom(.+\s)?vanities|discount(.+\s)?sofa|discount(.+\s)?sofas|double(.+\s)?bed|double(.+\s)?beds|dresser|dressers|end(.+\s)?table|end(.+\s)?tables|entertainment(.+\s)?center|entertainment(.+\s)?centers|exterior(.+\s)?light|exterior(.+\s)?light(.+\s)?fixture|exterior(.+\s)?light(.+\s)?fixtures|exterior(.+\s)?lighting|exterior(.+\s)?lighting(.+\s)?fixtures|exterior(.+\s)?lights|family(.+\s)?room(.+\s)?furniture|faucet|faucets|filing(.+\s)?cabinet|filing(.+\s)?cabinets|fireplace|fireplaces|flexible(.+\s)?track(.+\s)?lighting|flood(.+\s)?lights|floor(.+\s)?lamp|floor(.+\s)?lamps|floor(.+\s)?light|floor(.+\s)?lighting|floor(.+\s)?lights|fluorescent(.+\s)?light|fluorescent(.+\s)?lighting|fluorescent(.+\s)?lights|flush(.+\s)?mount(.+\s)?lighting|fountain|fountains|foyer(.+\s)?lighting|furniture(.+\s)?bedroom|futon|futons|garden(.+\s)?furniture|gazebo|gazebos|girls(.+\s)?bedroom(.+\s)?furniture|glass(.+\s)?dining(.+\s)?table|glass(.+\s)?dining(.+\s)?tables|hallway(.+\s)?table|hallway(.+\s)?tables|hammock|hammocks|handle|handles|hanging(.+\s)?lamps|hanging(.+\s)?light(.+\s)?fixtures|hanging(.+\s)?lights|headboard|headboards|home(.+\s)?office(.+\s)?furniture|house(.+\s)?lighting|hutch|hutches|indoor(.+\s)?lighting|interior(.+\s)?lighting|interior(.+\s)?lights|kids(.+\s)?bed|kids(.+\s)?bedroom(.+\s)?furniture|kids(.+\s)?beds|kids(.+\s)?furniture|kids(.+\s)?room(.+\s)?furniture|king(.+\s)?bed|king(.+\s)?beds|king(.+\s)?size(.+\s)?bed|king(.+\s)?size(.+\s)?beds|kitchen|kitchen(.+\s)?cabinet|kitchen(.+\s)?cabinets|kitchen(.+\s)?ceiling(.+\s)?lights|kitchen(.+\s)?chair|kitchen(.+\s)?chairs|kitchen(.+\s)?faucet|kitchen(.+\s)?faucets|kitchen(.+\s)?island(.+\s)?lighting|kitchen(.+\s)?light|kitchen(.+\s)?light(.+\s)?fixture|kitchen(.+\s)?light(.+\s)?fixtures|kitchen(.+\s)?lighting|kitchen(.+\s)?lighting(.+\s)?fixture|kitchen(.+\s)?lighting(.+\s)?fixtures|kitchen(.+\s)?lights|kitchen(.+\s)?pendant(.+\s)?lighting|kitchen(.+\s)?sink|kitchen(.+\s)?sinks|kitchen(.+\s)?table|kitchen(.+\s)?tables|kitchen(.+\s)?track(.+\s)?lighting|kitchens|knob|knobs|lamp|lamp(.+\s)?lighting|lamp(.+\s)?shade|lamp(.+\s)?shades|lamps|lamps(.+\s)?and(.+\s)?lighting|lamps(.+\s)?online|leather(.+\s)?chair|leather(.+\s)?chairs|leather(.+\s)?couch|leather(.+\s)?couches|leather(.+\s)?recliner|leather(.+\s)?recliners|leather(.+\s)?sectional|leather(.+\s)?sectional(.+\s)?sofa|leather(.+\s)?sectional(.+\s)?sofas|leather(.+\s)?sectionals|leather(.+\s)?sofa|leather(.+\s)?sofas|licing(.+\s)?room(.+\s)?chair|light(.+\s)?fitting|light(.+\s)?fittings|light(.+\s)?fixture|light(.+\s)?fixtures|light(.+\s)?lamp|lighting|lighting(.+\s)?fixture|lighting(.+\s)?fixtures|lightings|lights|living(.+\s)?room|living(.+\s)?room(.+\s)?chairs|living(.+\s)?room(.+\s)?furniture|living(.+\s)?room(.+\s)?furniture(.+\s)?sale|living(.+\s)?room(.+\s)?furniture(.+\s)?sets|living(.+\s)?room(.+\s)?lighting|living(.+\s)?room(.+\s)?set|living(.+\s)?room(.+\s)?sets|living(.+\s)?room(.+\s)?sofa|living(.+\s)?rooms|love(.+\s)?seat|love(.+\s)?seats|loveseat|loveseats|low(.+\s)?voltage(.+\s)?lighting|mirror|mirrored(.+\s)?furniture|mirrors|modern(.+\s)?bathroom(.+\s)?lighting|modern(.+\s)?bathroom(.+\s)?vanities|modern(.+\s)?bedroom(.+\s)?furniture|modern(.+\s)?chair|modern(.+\s)?chairs|modern(.+\s)?chandeliers|modern(.+\s)?dining(.+\s)?room(.+\s)?furniture|modern(.+\s)?dining(.+\s)?table|modern(.+\s)?kitchen|modern(.+\s)?lamp|modern(.+\s)?lighting|modern(.+\s)?lights|modern(.+\s)?office(.+\s)?furniture|modern(.+\s)?pendant(.+\s)?lighting|modern(.+\s)?sofa|modern(.+\s)?sofas|modular(.+\s)?kitchen|nightstand|nightstands|nursery(.+\s)?furniture|occasional(.+\s)?table|occasional(.+\s)?tables|office(.+\s)?chair|office(.+\s)?chairs|office(.+\s)?furniture|office(.+\s)?lighting|ottoman|ottomans|outdoor(.+\s)?firepit|outdoor(.+\s)?firepits|outdoor(.+\s)?fire(.+\s)?pit|outdoor(.+\s)?fire(.+\s)?pits|outdoor(.+\s)?furniture|outdoor(.+\s)?kitchen|outdoor(.+\s)?kitchens|outdoor(.+\s)?lamp|outdoor(.+\s)?lamps|outdoor(.+\s)?light|outdoor(.+\s)?light(.+\s)?fixtures|outdoor(.+\s)?lighting|outdoor(.+\s)?lighting(.+\s)?fixtures|outdoor(.+\s)?lightning|outdoor(.+\s)?lightings|outdoor(.+\s)?lights|outdoor(.+\s)?wall(.+\s)?light|outdoor(.+\s)?wall(.+\s)?lighting|outdoor(.+\s)?wall(.+\s)?lights|outdoor(.+\s)?wicker(.+\s)?furniture|outside(.+\s)?lighting|outside(.+\s)?lights|patio(.+\s)?furniture|patio(.+\s)?furniture(.+\s)?cover|patio(.+\s)?furniture(.+\s)?covers|patio(.+\s)?set|patio(.+\s)?sets|pendant(.+\s)?lamp|pendant(.+\s)?lamps|pendant(.+\s)?light|pendant(.+\s)?light(.+\s)?fixtures|pendant(.+\s)?lighting|pendant(.+\s)?lights|pillow|pillows|planter|planters|porch(.+\s)?lights|porch(.+\s)?swing|porch(.+\s)?swings|queen(.+\s)?bed|queen(.+\s)?beds|recliner|recliner(.+\s)?chair|recliner(.+\s)?chairs|recliners|rocking(.+\s)?chair|rocking(.+\s)?chairs|round(.+\s)?dining(.+\s)?table|rug|rugs|sconce|sconce(.+\s)?lighting|sconces|sectional|sectional(.+\s)?couch|sectional(.+\s)?couches|sectional(.+\s)?furniture|sectional(.+\s)?sofa|sectional(.+\s)?sofas|sectionals|shoerack|shoeracks|shoe(.+\s)?rack|shoe(.+\s)?racks|shower|showers|sideboards|single(.+\s)?bed|single(.+\s)?beds|singles(.+\s)?bed|singles(.+\s)?beds|sink|sinks|sleeper(.+\s)?sofa|sleeper(.+\s)?sofas|small(.+\s)?bathroom(.+\s)?vanities|small(.+\s)?kitchen(.+\s)?design|small(.+\s)?kitchen(.+\s)?ideas|sofa|sofa(.+\s)?bed|sofa(.+\s)?beds|sofa(.+\s)?furniture|sofa(.+\s)?sale|sofa(.+\s)?sales|sofa(.+\s)?set|sofa(.+\s)?sets|sofa(.+\s)?store|sofa(.+\s)?stores|sofa(.+\s)?table|sofa(.+\s)?tables|sofas|stool|stools|table|table(.+\s)?lamp|table(.+\s)?lamps|tables|tall(.+\s)?bathroom(.+\s)?cabinets|teak(.+\s)?outdoor(.+\s)?furniture|toilet|toilet(.+\s)?design|toilet(.+\s)?designs|toilets|tv(.+\s)?furniture|used(.+\s)?office(.+\s)?furniture|vanities|vanity|vanity(.+\s)?lighting|wall(.+\s)?lamp|wall(.+\s)?lamps|wall(.+\s)?light|wall(.+\s)?light(.+\s)?fixtures|wall(.+\s)?lighting|wall(.+\s)?lights|wall(.+\s)?sconce|wall(.+\s)?sconce(.+\s)?lighting|wall(.+\s)?sconces|wall(.+\s)?shelf|wall(.+\s)?shelves|white(.+\s)?bathroom(.+\s)?vanities|white(.+\s)?bedroom(.+\s)?furniture|wine(.+\s)?rack|wine(.+\s)?racks|wrought(.+\s)?iron(.+\s)?chandeliers)\b/gim;
        brandsInSearch = pipBrandForSergetInDomain.exec(searchTxt);
        } else {
        var pipBrandInDomain = /\b(accent (.+\s)?table|accent (.+\s)?tables|affordable (.+\s)?furniture|affordable
        (.+\s)?furniture (.+\s)?stores|affordable (.+\s)?home (.+\s)?furniture|affordable (.+\s)?modern
        (.+\s)?furniture|amish (.+\s)?furniture|antique (.+\s)?furniture|apartment
        (.+\s)?furniture|artwork|artworks|architectural (.+\s)?lighting|arm (.+\s)?chair|arm
        (.+\s)?chairs|armchair|armchairs|armoire|armoires|art (.+\s)?deco (.+\s)?furniture|ashleys (.+\s)?furniture|baby
        (.+\s)?furniture|badcock (.+\s)?furniture|baker (.+\s)?furniture|bamboo (.+\s)?furniture|bar
        (.+\s)?furniture|bar (.+\s)?stool|bar (.+\s)?stools|bargain (.+\s)?furniture|basin|basins|bath|bath
        (.+\s)?accessories|bath (.+\s)?accessory|bath (.+\s)?cabinet|bath (.+\s)?cabinets|bath (.+\s)?cupboard|bath
        (.+\s)?cupboards|bath (.+\s)?décor|bath (.+\s)?design|bath (.+\s)?designs|bath (.+\s)?faucet|bath
        (.+\s)?faucets|bath (.+\s)?fitting|bath (.+\s)?fittings|bath (.+\s)?fixture|bath (.+\s)?fixtures|bath
        (.+\s)?furniture|bath (.+\s)?hardware|bath (.+\s)?sink|bath (.+\s)?sinks|bath (.+\s)?tap|bath (.+\s)?taps|bath
        (.+\s)?vanities|bath (.+\s)?vanity|bathroom|bathroom (.+\s)?accessories|bathroom (.+\s)?accessory|bathroom
        (.+\s)?basin|bathroom (.+\s)?basins|bathroom (.+\s)?cabinet|bathroom (.+\s)?cabinets|bathroom (.+\s)?ceiling
        (.+\s)?light|bathroom (.+\s)?ceiling (.+\s)?lights|bathroom (.+\s)?cupboard|bathroom (.+\s)?cupboards|bathroom
        (.+\s)?decor|bathroom (.+\s)?design|bathroom (.+\s)?designs|bathroom (.+\s)?faucet|bathroom
        (.+\s)?faucets|bathroom (.+\s)?fitting|bathroom (.+\s)?fittings|bathroom (.+\s)?fixture|bathroom
        (.+\s)?fixtures|bathroom (.+\s)?furniture|bathroom (.+\s)?hardware|bathroom (.+\s)?light|bathroom (.+\s)?light
        (.+\s)?fixture|bathroom (.+\s)?light (.+\s)?fixtures|bathroom (.+\s)?lighting|bathroom (.+\s)?lighting
        (.+\s)?fixture|bathroom (.+\s)?lighting (.+\s)?fixtures|bathroom (.+\s)?lights|bathroom (.+\s)?sale|bathroom
        (.+\s)?sink|bathroom (.+\s)?sinks|bathroom (.+\s)?tap|bathroom (.+\s)?taps|bathroom (.+\s)?vanities|bathroom
        (.+\s)?vanity|bathroom (.+\s)?vanity (.+\s)?cabinet|bathroom (.+\s)?vanity (.+\s)?cabinets|bathroom
        (.+\s)?vanity (.+\s)?lighting|bathroom (.+\s)?vanity (.+\s)?unit|bathroom (.+\s)?vanity
        (.+\s)?units|bathrooms|baths|bathtub|bathtubs|bed|bed (.+\s)?frame|bed (.+\s)?frames|bed
        (.+\s)?furniture|bedroom|bedroom (.+\s)?furniture|bedroom (.+\s)?furniture (.+\s)?sale|bedroom (.+\s)?furniture
        (.+\s)?set|bedroom (.+\s)?furniture (.+\s)?sets|bedroom (.+\s)?furniture (.+\s)?stores|bedroom
        (.+\s)?lighting|bedroom (.+\s)?set|bedroom (.+\s)?sets|bedrooms|beds|bench|benches|bernhardt
        (.+\s)?furniture|best (.+\s)?furniture|best (.+\s)?furniture (.+\s)?stores|big (.+\s)?lots
        (.+\s)?furniture|black (.+\s)?bedroom (.+\s)?furniture|black (.+\s)?furniture|bobs (.+\s)?discount
        (.+\s)?furniture|bobs (.+\s)?furniture|bookcase|bookcases|boys (.+\s)?bedroom (.+\s)?furniture|broyhill|broyhill
        (.+\s)?furniture|bunck (.+\s)?beds|bunk (.+\s)?bed|bush (.+\s)?furniture|buy (.+\s)?furniture|buy
        (.+\s)?furniture (.+\s)?online|cabinet|cabinets|cable (.+\s)?lighting|cable (.+\s)?lightings|cane
        (.+\s)?furniture|ceiling (.+\s)?fan (.+\s)?chandelier|ceiling (.+\s)?fan (.+\s)?chandeliers|ceiling
        (.+\s)?lamp|ceiling (.+\s)?lamps|ceiling (.+\s)?light|ceiling (.+\s)?light (.+\s)?fixture|ceiling (.+\s)?light
        (.+\s)?fixtures|ceiling (.+\s)?lighting|ceiling (.+\s)?lights|chair|chairs|chaise|chaises|chaise
        (.+\s)?lounge|chaise (.+\s)?lounges|chandelier|chandelier (.+\s)?ceiling (.+\s)?fan|chandelier (.+\s)?ceiling
        (.+\s)?fans|chandelier (.+\s)?light|chandelier (.+\s)?lighting|chandelier (.+\s)?lights|chandeliers|changing
        (.+\s)?station|changing (.+\s)?stations|cheap (.+\s)?bathroom (.+\s)?vanities|cheap (.+\s)?bathroom
        (.+\s)?vanity|cheap (.+\s)?bedroom (.+\s)?furniture|cheap (.+\s)?furniture|cheap (.+\s)?furniture
        (.+\s)?online|cheap (.+\s)?furniture (.+\s)?stores|cheap (.+\s)?light (.+\s)?fixtures|cheap
        (.+\s)?lighting|cheap (.+\s)?living (.+\s)?room (.+\s)?furniture|cheap (.+\s)?modern (.+\s)?furniture|cheap
        (.+\s)?sofa|cheap (.+\s)?sofas|chest (.+\s)?of (.+\s)?drawers|children (.+\s)?bedroom (.+\s)?furniture|children
        (.+\s)?furniture|children's (.+\s)?bedroom (.+\s)?furniture|children's (.+\s)?furniture|classic
        (.+\s)?furniture|clearance (.+\s)?furniture|clock|clocks|coatstand|coatstands|coat (.+\s)?stand|coat
        (.+\s)?stands|coffee (.+\s)?table|coffee (.+\s)?tables|commercial (.+\s)?lighting (.+\s)?fixtures|computer
        (.+\s)?desk|computer (.+\s)?desks|conservatory (.+\s)?furniture|console (.+\s)?table|console
        (.+\s)?tables|contemporary (.+\s)?bathroom (.+\s)?vanities|contemporary (.+\s)?bedroom
        (.+\s)?furniture|contemporary (.+\s)?chandeliers|contemporary (.+\s)?furniture|contemporary
        (.+\s)?lamp|contemporary (.+\s)?lamps|contemporary (.+\s)?light (.+\s)?fixture|contemporary (.+\s)?light
        (.+\s)?fixtures|contemporary (.+\s)?lighting|contemporary (.+\s)?living (.+\s)?room
        (.+\s)?furniture|contemporary (.+\s)?outdoor (.+\s)?lighting|contemporary (.+\s)?sofa|contemporary
        (.+\s)?sofas|cool (.+\s)?furniture|cottage (.+\s)?furniture|couch|couches|country
        (.+\s)?furniture|crib|cribs|curio (.+\s)?cabinet|curio (.+\s)?cabinets|curtain|curtains|custom
        (.+\s)?furniture|danish (.+\s)?furniture|daybed|daybeds|deck (.+\s)?lighting|decorative (.+\s)?lamp|decorative
        (.+\s)?lamps|decorative (.+\s)?lighting|design (.+\s)?furniture|designer (.+\s)?furniture|designer
        (.+\s)?lighting|designer (.+\s)?lights|designer (.+\s)?sofa|designer (.+\s)?sofas|desk|desk (.+\s)?lamp|desk
        (.+\s)?lamps|desks|dinette (.+\s)?set|dinette (.+\s)?sets|dining (.+\s)?chair|dining (.+\s)?chairs|dining
        (.+\s)?furniture|dining (.+\s)?room|dining (.+\s)?room (.+\s)?chair|dining (.+\s)?room (.+\s)?chairs|dining
        (.+\s)?room (.+\s)?furniture|dining (.+\s)?room (.+\s)?furniture (.+\s)?set|dining (.+\s)?room (.+\s)?furniture
        (.+\s)?sets|dining (.+\s)?room (.+\s)?lighting|dining (.+\s)?room (.+\s)?set|dining (.+\s)?room
        (.+\s)?sets|dining (.+\s)?room (.+\s)?table|dining (.+\s)?room (.+\s)?tables|dining (.+\s)?rooms|dining
        (.+\s)?set|dining (.+\s)?sets|dining (.+\s)?table|dining (.+\s)?tables|discount (.+\s)?bathroom
        (.+\s)?vanities|discount (.+\s)?bedroom (.+\s)?furniture|discount (.+\s)?furniture|discount (.+\s)?furniture
        (.+\s)?stores|discount (.+\s)?light (.+\s)?fixtures|discount (.+\s)?lighting|discount (.+\s)?lighting
        (.+\s)?fixtures|discount (.+\s)?sofa|discount (.+\s)?sofas|display (.+\s)?lighting|double (.+\s)?bed|double
        (.+\s)?beds|dresser|dressers|end (.+\s)?table|end (.+\s)?tables|entertainment (.+\s)?center|entertainment
        (.+\s)?centers|exterior (.+\s)?light|exterior (.+\s)?light (.+\s)?fixture|exterior (.+\s)?light
        (.+\s)?fixtures|exterior (.+\s)?lighting|exterior (.+\s)?lighting (.+\s)?fixtures|exterior (.+\s)?lights|factory
        (.+\s)?direct (.+\s)?furniture|family (.+\s)?room (.+\s)?furniture|faucet|faucets|filing (.+\s)?cabinet|filing
        (.+\s)?cabinets|fine (.+\s)?furniture|fireplace|fireplaces|flexible (.+\s)?track (.+\s)?lighting|flood
        (.+\s)?lights|floor (.+\s)?lamp|floor (.+\s)?lamps|floor (.+\s)?light|floor (.+\s)?lighting|floor
        (.+\s)?lights|fluorescent (.+\s)?light|fluorescent (.+\s)?lighting|fluorescent (.+\s)?lights|flush (.+\s)?mount
        (.+\s)?lighting|fountain|fountains|foyer (.+\s)?lighting|free (.+\s)?furniture|french (.+\s)?country
        (.+\s)?furniture|french (.+\s)?furniture|furnishing|furnishings|furniture (.+\s)?accessories|furniture
        (.+\s)?bedroom|furniture (.+\s)?catalog|furniture (.+\s)?clearance|furniture (.+\s)?collection|furniture
        (.+\s)?companies|furniture (.+\s)?company|furniture (.+\s)?deals|furniture (.+\s)?delivery|furniture
        (.+\s)?design|furniture (.+\s)?designers|furniture (.+\s)?designs|furniture (.+\s)?direct|furniture
        (.+\s)?discount|furniture (.+\s)?factory|furniture (.+\s)?factory (.+\s)?outlet|furniture (.+\s)?fair|furniture
        (.+\s)?for (.+\s)?sale|furniture (.+\s)?liquidators|furniture (.+\s)?makers|furniture
        (.+\s)?manufacturers|furniture (.+\s)?mart|furniture (.+\s)?on (.+\s)?sale|furniture (.+\s)?online|furniture
        (.+\s)?outlet|furniture (.+\s)?outlet (.+\s)?stores|furniture (.+\s)?outlets|furniture (.+\s)?rental|furniture
        (.+\s)?repair|furniture (.+\s)?retailers|furniture (.+\s)?row|furniture (.+\s)?sale|furniture
        (.+\s)?sales|furniture (.+\s)?sets|furniture (.+\s)?shop|furniture (.+\s)?shops|furniture
        (.+\s)?showroom|furniture (.+\s)?store|furniture (.+\s)?stores|furniture (.+\s)?website|furniture
        (.+\s)?websites|furniture (.+\s)?wholesale|furniture (.+\s)?world|furniture's|furniture's
        (.+\s)?stores|futon|futons|gallery (.+\s)?furniture|garden (.+\s)?furniture|gazebo|gazebos|girls (.+\s)?bedroom
        (.+\s)?furniture|glass (.+\s)?dining (.+\s)?table|glass (.+\s)?dining (.+\s)?tables|hallway (.+\s)?table|hallway
        (.+\s)?tables|halogen (.+\s)?light|halogen (.+\s)?lights|hammock|hammocks|handle|handles|hanging
        (.+\s)?lamps|hanging (.+\s)?light (.+\s)?fixtures|hanging (.+\s)?lights|headboard|headboards|home
        (.+\s)?furnishing|home (.+\s)?furnishings|home (.+\s)?furniture|home (.+\s)?furniture (.+\s)?showroom|home
        (.+\s)?furniture (.+\s)?stores|home (.+\s)?lighting|home (.+\s)?office (.+\s)?furniture|hooker
        (.+\s)?furniture|hotel (.+\s)?furniture|house (.+\s)?furniture|house (.+\s)?lighting|hutch|hutches|indoor
        (.+\s)?lighting|inexpensive (.+\s)?furniture|interior (.+\s)?lighting|interior (.+\s)?lights|italian
        (.+\s)?furniture|italian (.+\s)?lighting|jordans (.+\s)?furniture|kids (.+\s)?bed|kids (.+\s)?bedroom
        (.+\s)?furniture|kids (.+\s)?beds|kids (.+\s)?furniture|kids (.+\s)?room (.+\s)?furniture|kincaid
        (.+\s)?furniture|king (.+\s)?bed|king (.+\s)?beds|king (.+\s)?size (.+\s)?bed|king (.+\s)?size
        (.+\s)?beds|kitchen|kitchen (.+\s)?cabinet|kitchen (.+\s)?cabinets|kitchen (.+\s)?ceiling (.+\s)?lights|kitchen
        (.+\s)?chair|kitchen (.+\s)?chairs|kitchen (.+\s)?faucet|kitchen (.+\s)?faucets|kitchen (.+\s)?island
        (.+\s)?lighting|kitchen (.+\s)?light|kitchen (.+\s)?light (.+\s)?fixture|kitchen (.+\s)?light
        (.+\s)?fixtures|kitchen (.+\s)?lighting|kitchen (.+\s)?lighting (.+\s)?fixture|kitchen (.+\s)?lighting
        (.+\s)?fixtures|kitchen (.+\s)?lights|kitchen (.+\s)?pendant (.+\s)?lighting|kitchen (.+\s)?sink|kitchen
        (.+\s)?sinks|kitchen (.+\s)?table|kitchen (.+\s)?tables|kitchen (.+\s)?track
        (.+\s)?lighting|kitchens|knob|knobs|lamp|lamp (.+\s)?lighting|lamp (.+\s)?shade|lamp (.+\s)?shades|lamp
        (.+\s)?store|lamps|lamps (.+\s)?and (.+\s)?lighting|lamps (.+\s)?online|lane (.+\s)?furniture|leather
        (.+\s)?chair|leather (.+\s)?chairs|leather (.+\s)?couch|leather (.+\s)?couches|leather (.+\s)?furniture|leather
        (.+\s)?recliner|leather (.+\s)?recliners|leather (.+\s)?sectional|leather (.+\s)?sectional (.+\s)?sofa|leather
        (.+\s)?sectional (.+\s)?sofas|leather (.+\s)?sectionals|leather (.+\s)?sofa|leather (.+\s)?sofas|led (.+\s)?home
        (.+\s)?lighting|led (.+\s)?light (.+\s)?fixtures|led (.+\s)?lighting|lexington (.+\s)?furniture|licing
        (.+\s)?room (.+\s)?chair|light (.+\s)?fitting|light (.+\s)?fittings|light (.+\s)?fixture|light
        (.+\s)?fixtures|light (.+\s)?lamp|light (.+\s)?store|lighting|lighting (.+\s)?companies|lighting
        (.+\s)?company|lighting (.+\s)?design|lighting (.+\s)?designer|lighting (.+\s)?fixture|lighting
        (.+\s)?fixtures|lighting (.+\s)?manufacturers|lighting (.+\s)?online|lighting (.+\s)?sale|lighting
        (.+\s)?shop|lighting (.+\s)?shops|lighting (.+\s)?store|lighting (.+\s)?stores|lighting
        (.+\s)?suppliers|lightings|lights|living (.+\s)?room|living (.+\s)?room (.+\s)?chairs|living (.+\s)?room
        (.+\s)?furniture|living (.+\s)?room (.+\s)?furniture (.+\s)?sale|living (.+\s)?room (.+\s)?furniture
        (.+\s)?sets|living (.+\s)?room (.+\s)?lighting|living (.+\s)?room (.+\s)?set|living (.+\s)?room
        (.+\s)?sets|living (.+\s)?room (.+\s)?sofa|living (.+\s)?rooms|local (.+\s)?furniture (.+\s)?stores|log
        (.+\s)?furniture|lounge (.+\s)?furniture|love (.+\s)?seat|love (.+\s)?seats|loveseat|loveseats|low
        (.+\s)?voltage (.+\s)?lighting|luxury (.+\s)?furniture|maple (.+\s)?furniture|metal
        (.+\s)?furniture|mirror|mirrored (.+\s)?furniture|mirrors|mission (.+\s)?furniture|mission (.+\s)?style
        (.+\s)?furniture|modern (.+\s)?bathroom (.+\s)?lighting|modern (.+\s)?bathroom (.+\s)?vanities|modern
        (.+\s)?bedroom (.+\s)?furniture|modern (.+\s)?chair|modern (.+\s)?chairs|modern (.+\s)?chandeliers|modern
        (.+\s)?contemporary (.+\s)?furniture|modern (.+\s)?dining (.+\s)?room (.+\s)?furniture|modern (.+\s)?dining
        (.+\s)?table|modern (.+\s)?furniture|modern (.+\s)?furniture (.+\s)?design|modern (.+\s)?furniture
        (.+\s)?stores|modern (.+\s)?kitchen|modern (.+\s)?lamp|modern (.+\s)?lamps|modern (.+\s)?light
        (.+\s)?fixtures|modern (.+\s)?lighting|modern (.+\s)?lighting (.+\s)?fixtures|modern (.+\s)?lights|modern
        (.+\s)?living (.+\s)?room (.+\s)?furniture|modern (.+\s)?office (.+\s)?furniture|modern (.+\s)?outdoor
        (.+\s)?furniture|modern (.+\s)?pendant (.+\s)?lighting|modern (.+\s)?sofa|modern (.+\s)?sofas|modular
        (.+\s)?furniture|modular (.+\s)?kitchen|monorail (.+\s)?lighting|nebraska (.+\s)?furniture (.+\s)?mart|new
        (.+\s)?furniture|nightstand|nightstands|north (.+\s)?carolina (.+\s)?furniture|nursery (.+\s)?furniture|oak
        (.+\s)?furniture|occasional (.+\s)?table|occasional (.+\s)?tables|office (.+\s)?chair|office
        (.+\s)?chairs|office (.+\s)?furniture|office (.+\s)?lighting|online (.+\s)?furniture|online (.+\s)?furniture
        (.+\s)?shopping|online (.+\s)?furniture (.+\s)?stores|online (.+\s)?lighting|oriental
        (.+\s)?furniture|ottoman|ottomans|outdoor (.+\s)?firepit|outdoor (.+\s)?firepits|outdoor (.+\s)?fire
        (.+\s)?pit|outdoor (.+\s)?fire (.+\s)?pits|outdoor (.+\s)?furniture|outdoor (.+\s)?kitchen|outdoor
        (.+\s)?kitchens|outdoor (.+\s)?lamp|outdoor (.+\s)?lamps|outdoor (.+\s)?light|outdoor (.+\s)?light
        (.+\s)?fixtures|outdoor (.+\s)?lighting|outdoor (.+\s)?lighting (.+\s)?fixtures|outdoor (.+\s)?lightning|outdoor
        (.+\s)?lightings|outdoor (.+\s)?lights|outdoor (.+\s)?wall (.+\s)?light|outdoor (.+\s)?wall
        (.+\s)?lighting|outdoor (.+\s)?wall (.+\s)?lights|outdoor (.+\s)?wicker (.+\s)?furniture|outside
        (.+\s)?lighting|outside (.+\s)?lights|painted (.+\s)?furniture|patio (.+\s)?furniture|patio (.+\s)?furniture
        (.+\s)?cover|patio (.+\s)?furniture (.+\s)?covers|patio (.+\s)?set|patio (.+\s)?sets|pendant (.+\s)?lamp|pendant
        (.+\s)?lamps|pendant (.+\s)?light|pendant (.+\s)?light (.+\s)?fixtures|pendant (.+\s)?lighting|pendant
        (.+\s)?lights|pillow|pillows|pine (.+\s)?furniture|planter|planters|porch (.+\s)?lights|porch (.+\s)?swing|porch
        (.+\s)?swings|pulaski (.+\s)?furniture|quality (.+\s)?furniture|queen (.+\s)?bed|queen (.+\s)?beds|rattan
        (.+\s)?furniture|recessed (.+\s)?light|recessed (.+\s)?lighting|recessed (.+\s)?lights|recliner|recliner
        (.+\s)?chair|recliner (.+\s)?chairs|recliners|residential (.+\s)?lighting|restaurant (.+\s)?furniture|restaurant
        (.+\s)?lighting|retro (.+\s)?furniture|riverside (.+\s)?furniture|rocking (.+\s)?chair|rocking
        (.+\s)?chairs|room (.+\s)?furniture|round (.+\s)?dining (.+\s)?table|rug|rugs|rustic (.+\s)?furniture|rustic
        (.+\s)?lighting|sauder (.+\s)?furniture|scandinavian (.+\s)?furniture|school (.+\s)?furniture|sconce|sconce
        (.+\s)?lighting|sconces|second (.+\s)?hand (.+\s)?furniture|sectional|sectional (.+\s)?couch|sectional
        (.+\s)?couches|sectional (.+\s)?furniture|sectional (.+\s)?sofa|sectional (.+\s)?sofas|sectionals|shabby
        (.+\s)?chic (.+\s)?furniture|shaker (.+\s)?furniture|shoerack|shoeracks|shoe (.+\s)?rack|shoe (.+\s)?racks|shop
        (.+\s)?furniture|shop (.+\s)?lighting|shower|showers|sideboards|single (.+\s)?bed|single (.+\s)?beds|singles
        (.+\s)?bed|singles (.+\s)?beds|sink|sinks|sleeper (.+\s)?sofa|sleeper (.+\s)?sofas|small (.+\s)?bathroom
        (.+\s)?vanities|small (.+\s)?kitchen (.+\s)?design|small (.+\s)?kitchen (.+\s)?ideas|sofa|sofa (.+\s)?bed|sofa
        (.+\s)?beds|sofa (.+\s)?furniture|sofa (.+\s)?sale|sofa (.+\s)?sales|sofa (.+\s)?set|sofa (.+\s)?sets|sofa
        (.+\s)?store|sofa (.+\s)?stores|sofa (.+\s)?table|sofa (.+\s)?tables|sofas|solid (.+\s)?wood
        (.+\s)?furniture|star (.+\s)?furniture|stool|stools|table|table (.+\s)?lamp|table (.+\s)?lamps|tables|tall
        (.+\s)?bathroom (.+\s)?cabinets|teak (.+\s)?furniture|teak (.+\s)?outdoor (.+\s)?furniture|the (.+\s)?furniture
        (.+\s)?store|the (.+\s)?lighting (.+\s)?company|thomasville (.+\s)?furniture|toilet|toilet (.+\s)?design|toilet
        (.+\s)?designs|toilets|track (.+\s)?light|track (.+\s)?lighting|track (.+\s)?lighting (.+\s)?fixtures|track
        (.+\s)?lights|traditional (.+\s)?furniture|tv (.+\s)?furniture|unfinished (.+\s)?furniture|unfinished
        (.+\s)?wood (.+\s)?furniture|unique (.+\s)?furniture|upholstered (.+\s)?furniture|used (.+\s)?furniture|used
        (.+\s)?office (.+\s)?furniture|vanities|vanity|vanity (.+\s)?lighting|vase|vases|victorian
        (.+\s)?furniture|vintage (.+\s)?furniture|wall (.+\s)?lamp|wall (.+\s)?lamps|wall (.+\s)?light|wall (.+\s)?light
        (.+\s)?fixtures|wall (.+\s)?lighting|wall (.+\s)?lights|wall (.+\s)?sconce|wall (.+\s)?sconce
        (.+\s)?lighting|wall (.+\s)?sconces|wall (.+\s)?shelf|wall (.+\s)?shelves|waste (.+\s)?basket|waste
        (.+\s)?baskets|white (.+\s)?bathroom (.+\s)?vanities|white (.+\s)?bedroom (.+\s)?furniture|white
        (.+\s)?furniture|wholesale (.+\s)?furniture|wholesale (.+\s)?lighting|wicker (.+\s)?furniture|wickes
        (.+\s)?furniture|wine (.+\s)?rack|wine (.+\s)?racks|wood (.+\s)?furniture|wooden (.+\s)?furniture|wrought
        (.+\s)?iron (.+\s)?chandeliers|wrought (.+\s)?iron (.+\s)?furniture)\b/gim;
        ...
        if(!similarproducts.b.LTDGoogleImageMatchedBrand || similarproducts.b.LTDGoogleImageMatchedBrand !==
        brandInDomain){
        ...
        reportParamsString += similarproducts.utilities.abTestUtil &&
        similarproducts.utilities.abTestUtil.getDataString() || '';
        ...
        {
        ssg.isSearchSearchget = true ;
        ssg.cssStore = 'display:block; font-size:11px; color:#1E7D83; text-decoration none; width:90px; overflow:hidden;
        text-overflow:ellipsis; line-height:15px;';
        ...
        // if (spsupport.p.dlsource == "conduit" || spsupport.p.dlsource == "conduit2" || spsupport.p.dlsource ==
        "conduit3") {
        // ssg.sSite = 0;
        // }
        }
        ...
        spsupport.p.prodPage.d = 149;
        spsupport.p.prodPage.l = 1500;
        var vQ = '#vi-tTblC2 > div, #RightSummaryPanel > div, #AdPanel, #BuyingOptions3, #viewad-sidebar';
        //#BuyOptionsWrapper';//.si-trs-top'; // default (us)
        ...
        else if (document.location.href.indexOf('/itm/') > -1 || document.location.href.indexOf('/ctg/') > -1) { //
        vi-ih-bc-label
        if (!lNode) {
        nd = spsupport.p.$('h1');
        ...
        ssg.cssPrice = 'font-weight: bold;';
        ssg.cssStore = ssg.cssStore || 'display:block; color:green;text-decoration: none; width: 90px; overflow:
        hidden;line-height:15px;';
        ssg.cssPrompt = 'top: 20px; right: -37px;';
        ssg.q = this.dt.q;
        if (this.dt.relpos) {
        ...
        } else if(spsupport.p.siteDomain === 'surfcanyon.com'){ // can remove if container exists (id =
        'surfcanyon-serget-container')
        var anc = spsupport.p.$('#resultTable tr:not([id])')[0].parentNode.children[1];
        spsupport.p.$('<tr><td class="position"></td><td><div id="surfcanyon-serget-container" style="width: 546px;
        height: 210px; display: none"></div></td></tr>')['insertAfter'](anc)[0];
        ssg.sSite = this.dt.num || 8;
        this.jAnc = spsupport.p.$(ssg.q);
        }
        ...
        if (this.dt && this.jAnc.length && (this.toSend(txtsArr) || (this.dt.mn !== 'Surfcanyon' &&
        this.checkPip(txtsArr, term)))) {
        ...
        searchgetReportImg.src = spsupport.p.sfDomain+spsupport.p.sessRepAct+'?action=searchgetReport&page_url=' +
        encodeURIComponent(window.location.href) + '&source_id='+this.reason+'&dscr=' +
        this.searchgetReport.join('==>');
        ...
        var pipBrandInDomain = "\\b"+ similarproducts.b.pipBrandInDomain.replace(/\s*\|[\s\|]*(\S\s*\|+)?/g,"\\b|\\b") +
        "\\b";
        var rBrands = new RegExp(pipBrandInDomain, 'gi');
        var reason = '';
        var mBr = [], cmBr = [];
        ...
        similarproducts.b.inj(window.document, similarproducts.b.site + "slideup2/main.js?ver=" +
        similarproducts.b.appVersion , 1);
        similarproducts.b.inj(window.document, similarproducts.b.site + "side_slider/main.js?ver=" +
        similarproducts.b.appVersion , 1);
        similarproducts.b.inj(window.document, similarproducts.b.site + "js/base_single_icon.js?ver=" +
        similarproducts.b.appVersion , 1);
        ...
        spsupport.api.sendMessageToExtenstion("SuperfishSaveSuggestToUpdateBHODateMessage", { date:
        spsupport.p.getDateFormated() } );
        window.open(spsupport.p.sfDomain + "html/suggestToUpdateBHO.html?domain=" +
        spsupport.p.sfDomain,"Update","height=274,width=336");
        }
        }
        }
        }
        ...
        return this.domain+'/images/ws-share/'+(type == 'pin' ? 'pinit-btn-2.png' : 'fb_share.png'); //this.CONST.PRT +
        this.CONST.DOMAIN + this.CONST.CONTEXT_PATH + "/images/ws-share/"+(type == 'pin' ? 'pinit-btn-2.png' :
        'fb_share.png');
        },
        ...
        var shareURL = searchURL.replace('findByUrlSfsrp', 'shareURL').replace('findByUrl', 'shareURL');//TODO: use a
        serverside constant for shareUrl path instead of replace():
        ...
        this.additionalRules = spsupport.sites && spsupport.sites.rules() || {}; // Get additional modifications per
        domain
        ...
        {
        if(!(spsupport.p.pageType == 'SRP' && similarproducts.b.numOfDisplayedInImgUnits>0)){
        this.aboveTheFold = true;
        }
        }

        if (!similarproducts.b.userData.storageData['sf_uninstall_bottom_banner'] &&
        similarproducts.b.bottomBannerWithIdenticals)
        {
        ...
        var possibleItemsInView = Math.floor((this.view.injectionNode.w - 26 + additionalSpace - padding) / 65); // 26
        is the more size
        ...
        {
        possibleItemsInMicroView = Math.floor((this.view.injectionNode.w - 26 - 6)/49); // 26 is the more, 6 is for the
        padding
        ...
        if (this.view.injectionNode.w > 350 && this.displayMode !== 'trusty' && spsupport.p.siteDomain !==
        'craigslist.org') // The last condition is temporary for the craigslist ctr drop test
        {
        finalItemsCount = (this.items.length > 4) ? 4 : this.items.length;
        this.viewParams.itemSize = Math.min(Math.floor((this.view.injectionNode.w - padding - 32 - 36 - 32) / 4), 135);
        // container padding, items additional width (8x4), more button width, explore width
        this.viewParams.mode = 'generic';
        }
        else
        {
        finalItemsCount = (possibleItemsInView > itemsLimit || possibleItemsInView > itemsCount) ? itemsCount :
        possibleItemsInView;
        ...
        if (item.freeShipping || item.bestPrice || (markPopular && item.resType === 'POP' && (this.testBucket ==
        '2015w03_POP_inimg_A' || this.testBucket == '2015w03_POP_inimg_B'))) // Set item label
        {
        if (item.resType === 'POP')
        {
        ...
        item.thumbContent = item.bestPrice ? similarproducts.languages[similarproducts.b.userData.lang].bestPrice :
        similarproducts.languages[similarproducts.b.userData.lang].freeShipping;
        }

        item.ribbonsUrl = 'background-image: url('+ spsupport.p.imgPath +
        'inimg2/inimg_tiles_'+similarproducts.b.userData.lang+'.png);';
        }
        ...
        partnerName: similarproducts.b.qsObj.partnername ?
        similarproducts.b.encodeDecode(false,similarproducts.b.qsObj.partnername) :
        similarproducts.b.psuSupportedByText,
        ...
        // In cases where the inimg left position was too close to the edge of the page and causing the first item's
        hover info box to be partly invisible
        ...
        this.$('.item_info_tip div', element).css('left', (this.viewParams.itemSize - 43) / 2 - 10 +
        elementOffset.left); // 43px - width of the info box tip arrow
        }
        },
        ...
        {
        var ind = +event.currentTarget.parentElement.parentNode.id.split('_')[2]
        var injectionNode = this.injectionNodes[ind];
        var popup = this.$(this.sfUtils.bubble());
        var popupPosition = this.sfUtils.getPosition(injectionNode.x, injectionNode.y, injectionNode.w,
        injectionNode.h);
        ...
        {
        this.sfUtils.sendRequest('{"cmd": 6, "iiInd": '+ind+', "rqSrc": 1 }'); // Dunno what the fuck those values mean,
        but it's working.
        }
        else
        {
        ...
        this.sfUtils.sendRequest('{"cmd": 13, "action": "' + reportString + '"}');
        ...
        {
        info.jInfo = this.$(info.ci(spsupport.p.sfDomain, similarproducts.b.dlsource, similarproducts.b.userid,
        similarproducts.b.CD_CTID, this.appVersion)).appendTo(document.body);
        ...
        if(similarproducts.b.userData.autoOpenFullUi === 1){
        inimg.openFullUI('autoOpenFullUi');
        }
        },
        ...
        // There's a special place in hell for people who write code like that, a place where you have to install HP
        printer drivers all day on Win95.
        ...
        t.itemWidth = 152;
        t.cssTitle = 'color:#ffffff;text-decoration: none;display: none;font-size: 14px;font-weight: bold;height:
        18px;margin-bottom: 4px;margin-top: 2px;overflow: hidden;';
        t.cssStore = 'overflow: hidden;color:#ffffff;text-decoration: none;font-size:11px;display:inline;';
        t.cssPrice = 'font-size: 12px;font-weight: bold;color:#ffffff;text-decoration: none;display:
        ...
        sr = (window.location.protocol.indexOf( "https" ) > -1 ? t.obj[i].imagePath.replace("http:", "https:") :
        t.obj[i].imagePath);
        if (im) {im.src = sr;}
        ...
        var href = (similarproducts.b.sgSupportedByLink &&
        similarproducts.b.sgSupportedByLink.indexOf("javascript:void(0)") === -1) ? '<a href="'+
        similarproducts.b.sgSupportedByLink + '"' + (similarproducts.b.sgSupportedByLink.indexOf("javascript:")==-1?'
        target="_blank"':"") + ' style="' + this.cssPowered + '">' : '';
        ...
        (this.pwrd ? '<td style="' + this.cssPowered + (similarproducts.b.sgAllenby ? 'padding-right: '+ this.rPad
        +'px;' : '') + '">'+this.powered1+ href + similarproducts.b.sgSupportedByText +(href ? '</a>' : '') +
        '&nbsp;&nbsp;<span id="SF_SG_CLOSE" style="cursor: pointer;"
        onclick="similarproducts.sg.sleep()">[x]</span></td>':''),
        '</tr>',
        '</table>',
        ...
        var sp = spsupport.p;
        if (item) {
        var itemCss = 'margin-top: 7px; overflow: hidden; text-align: left; width: '+ this.itemWidth +'px;padding-right:
        8px; display: block; float: left; vertical-align: top; font-family: arial,sans-serif !important; font-size: 13px
        !important; line-height: 15px !important;';
        var itemInner = '';
        var aImg = 'display: block; width: 82px; height: 82px; text-align: center; vertical-align: middle; border:1px
        solid #1111CC;';
        ...
        var merchData = '';
        var tag = 'a';
        var vst = 'background: -moz-linear-gradient(center top , #CC2D4C, #B02641) repeat scroll 0 0 transparent;border:
        1px solid #81002B;border-radius: 4px 4px 4px 4px;box-shadow: 0 1px 1px rgba(255, 255, 255, 0.35);cursor:
        pointer;font-size: 12px;margin-left: 0;margin-top: 5px;padding: 2px;text-align: center;width: 65px;';
        if (similarproducts.b.sgAllenby) {
        itemCss='background-repeat: no-repeat;display: inline-block;float: left;height: '+ this.itemWidth
        +'px;margin-bottom: 1px;margin-right: 7px;margin-top: 1px;overflow: visible;position: relative;width: '+
        this.itemWidth +'px;';
        itemInner = 'background-color: #ffffff;box-shadow: 0 1px 1px rgba(0, 0, 0, 0.5);cursor: pointer;display:
        block;height: '+ (this.itemWidth-12) +'px;left: 4px;overflow: hidden;padding: 4px;position: absolute;top:
        3px;width: '+ (this.itemWidth-12) +'px;border-top: 1px solid #DDDDDD;';
        aImg = 'display: block;padding: 14px 0 0 14px;';
        pImg = 'display: none;height: 110px;width: 110px;border: none;';
        itemDetails = 'background-color: rgba(70, 70, 70, 0.9);border-top-left-radius: 5px;border-top-right-radius:
        5px;color: white;cursor: pointer;font-size: 8pt;height: 100px;padding: 6px 8px 5px;position: absolute;top:
        124px;width: 124px;text-decoration: none;';
        ...
        '<img id="SF_SRG_IMG_' + index + '" ' +sp.sfIcon.evl+ '="-1" sfnoicon="1" style="'+pImg+'"
        onload="similarproducts.sg.showImage(this, \''+spin+'\');" />' +
        '<img id= "' + spin + '" src = "' + sp.iSpin.src + '" style="'+spinImg+'" />' +
        '</a>' +
        (similarproducts.b.sgAllenby ? '<a class="itemDetails" style="'+itemDetails+'" href="'+ item.merchURL
        +'&clickSrc=6" target="_blank">' : '') +
        '<'+tag+' class = "brand" href="'+ item.merchURL +'&clickSrc=3" target="_blank" style="'+this.cssTitle+'">'+
        item.title +'</'+tag+'>' +
        '<div class="merchData" style="'+merchData+'">' +
        '<div sfprice="1" style = "'+this.cssPrice+'">' + item.price + '</div>'+
        '<'+tag+' href="'+ item.merchURL +'&clickSrc=5" target="_blank"
        style="'+this.cssStore+'">'+item.merchantName+'</'+tag+'>' +
        '</div>'+
        ...
        var bEvt = " onmouseover='similarproducts.sg.sgBtnEvt(this,1)' onmouseout='similarproducts.sg.sgBtnEvt(this,0)'
        onmousedown='similarproducts.sg.sgBtnEvt(this,2)' onmouseup='similarproducts.sg.sgBtnEvt(this,4)' ";
        var prompt = "<div id='SF_SG_PAUSE_PROMPT' style='width:200px;height:76px;background:url(" + imUrlDef +
        "bgPSgP.png);position: absolute;z-index:10; font-size:12px;text-align:center;padding:18px 10px 0
        10px;line-height:14px;"+this.cssPrompt+"'>" + this.prompt + this.sleepText +
        "<table border='0' cellspacing='0' cellpadding = '0' style='margin:1px auto 0;padding:0;'><tbody><tr><td
        style='padding:0;'><div id='SF_SG_B_PAUSE_OK' style='margin:2px;width:57px;height:20px;background:url(" +
        imUrlDef + "bPreSu.png) 0px -20px no-repeat;' " + bEvt + "></div></td>" +
        "<td style='padding:0;'><div id='SF_SG_B_CLOSE' style='margin:2px;width:57px;height:20px;background:url(" +
        imUrlDef + "bPreSu.png) 0px 0px no-repeat;' " + bEvt + "></div></td></tr></tbody></table>" +
        "</div>"
        ...
        similarproducts.util.sendRequest("{\"cmd\": 2, \"type\": 2, \"cookie\": \""+this.cookie+"\", \"sleep\":
        \""+this.sleepTime+"\" }");
        this.close();
        spsupport.api.fixDivsPos();
        }
        ...
        if (spsupport.p.siteType != undefined && this.states.rmEnabledAwake && this.supportedSiteTypes.indexOf(";" +
        spsupport.p.siteType + ";") != -1){
        this.states.isAwake = true;
        }

        var isLocationMatched =
        window.location.href.toLowerCase().match(this.supportedSites.toLowerCase().replace(/;/g,"|"));
        ...
        'As a reminder, SimilarProducts is a free browser add-on brought to you by <a
        href="http://www.similarproducts.net/">SimilarProducts, Inc.</a> '+
        'When shopping at your favorite stores, you can click on the &ldquo;See Similar&rdquo; icon or receive suggested
        results for great deals. '+
        ...
        'By clicking "Accept", you agree to abide by the <a href="http://www.similarproducts.net/terms-of-use/">Terms of
        Use</a> and <a href="http://www.similarproducts.net/privacy-policy/">Privacy Policy</a>.';
